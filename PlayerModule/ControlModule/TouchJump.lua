...
function u1.EnableButton(u5, p6) -- Line: 74
    ...
    if p6 then
        ...
        u5._connectionUtil:trackConnection("JUMP_INPUT_ENDED", u5.jumpButton.InputEnded:Connect(function(p7) -- Line: 90
            -- upvalues: u5 (copy)
            if p7 == u5.touchObject then
                u5:_reset();
            end;
        end));
        u5._connectionUtil:trackConnection("MENU_OPENED", GuiService.MenuOpened:Connect(function() -- Line: 100
            -- upvalues: u5 (copy)
...
function u1.UpdateEnabled(p8) -- Line: 117
...
function u1._setupConfigurations(u10) -- Line: 126
    -- upvalues: CharacterUtil (copy)
    ...
    local v14 = CharacterUtil.onChild("Humanoid", "Humanoid", function(p11) -- Line: 132
        ...
        u10._connectionUtil:trackConnection("HUMANOID_STATE_ENABLED_CHANGED", p11.StateEnabledChanged:Connect(function(p12, p13) -- Line: 140
            -- upvalues: u10 (ref)
...
function u1.Enable(p15, p16, p17) -- Line: 152
    if p17 then
...
function u1.Create(u18) -- Line: 169
    ...
    u18.touchObject = nil;
    u18.jumpButton.InputBegan:connect(function(p21) -- Line: 206
        -- upvalues: u18 (copy)
