...
function v26.getRotationActivated() -- Line: 196
    -- upvalues: u28 (ref), u29 (copy)
    return u28 > 0 and true or u29.Thumbstick2.Magnitude > 0;
end;

function v26.getRotation(p34, p35) -- Line: 200
    -- upvalues: UserGameSettings (copy), u1 (copy), u30 (copy), u23 (ref), u29 (copy), u31 (copy), adjustTouchPitchSensitivity (copy), u32 (copy), u2 (ref), u3 (copy), u4 (copy), u5 (copy)
    ...
    return (v37 * 2.0943951023931953 + v38 * u2 + Movement * u3 + Pan * u4 + v39 * u5) * v36;
end;

function v26.getZoomDelta() -- Line: 234
    -- upvalues: u30 (copy), u31 (copy), u32 (copy)
    return (u30.O - u30.I) * 0.1 + (-u31.Wheel + u31.Pinch) * 1 + -u32.Pinch * 0.04;
end;

local function thumbstick(p40, p41, p42) -- Line: 242
...
local function mouseMovement(p43) -- Line: 248
    -- upvalues: u31 (copy)
    local Delta = p43.Delta;
    u31.Movement = Vector2.new(Delta.X, Delta.Y);
end;

local function mouseWheel(p44, p45, p46) -- Line: 253
    -- upvalues: u31 (copy)
...
local function keypress(p47, p48, p49) -- Line: 258
    -- upvalues: u30 (copy)
    u30[p49.KeyCode.Name] = p48 == Enum.UserInputState.Begin and 1 or 0;
end;

local function gamepadZoomPress(p50, p51, p52) -- Line: 262
...
local function gamepadReset(p53, p54, p55) -- Line: 268
    -- upvalues: u33 (copy)
...
local function resetInputDevices() -- Line: 274
    -- upvalues: u29 (copy), u30 (copy), u31 (copy), u32 (copy), u7 (ref), u28 (ref)
    for _, v in pairs({
        u29,
        u30,
        u31,
...
local function touchBegan(p59, p60) -- Line: 302
...
local function touchEnded(p61, p62) -- Line: 322
...
local function touchChanged(p63, p64) -- Line: 341
    -- upvalues: u57 (ref), u56 (ref), u32 (copy), u58 (ref)
...
local function resetTouchState() -- Line: 385
    -- upvalues: u56 (ref), u57 (ref), u58 (ref), u6 (ref), u28 (ref)
    u56 = {};
    u57 = nil;
    u58 = nil;
...
local function pointerAction(p68, p69, p70, p71) -- Line: 395
    -- upvalues: u31 (copy)
    if not p71 then
        u31.Wheel = p68;
        u31.Pan = p69;
...
local function inputBegan(p72, p73) -- Line: 403
...
local function inputChanged(p74, p75) -- Line: 412
...
local function inputEnded(p76, p77) -- Line: 421
...
function v26.setInputEnabled(p79) -- Line: 432
    -- upvalues: u78 (ref), resetInputDevices (copy), resetTouchState (ref), ContextActionService (copy), thumbstick (copy), Value (copy), keypress (copy), VRService (copy), gamepadReset (copy), gamepadZoomPress (copy), u27 (ref), UserInputService (copy), inputBegan (copy), inputChanged (copy), inputEnded (copy), pointerAction (copy), u6 (ref)
    if u78 == p79 then
        return;
    end;
...
function v26.getInputEnabled() -- Line: 504
    -- upvalues: u78 (ref)
    return u78;
end;

function v26.resetInputForFrameEnd() -- Line: 508
...
function v26.getHoldPan() -- Line: 529
    -- upvalues: u80 (ref)
    return u80;
end;

function v26.getTogglePan() -- Line: 533
    -- upvalues: u81 (ref)
    return u81;
end;

function v26.getPanning() -- Line: 537
    -- upvalues: u81 (ref), u80 (ref)
    return u81 or u80;
end;

function v26.setTogglePan(p83) -- Line: 541
    -- upvalues: u81 (ref)
    u81 = p83;
end;
...
function v26.enableCameraToggleInput() -- Line: 549
    ...
    u85 = Event:Connect(function() -- Line: 566
        -- upvalues: u80 (ref), u82 (ref)
        u80 = true;
        u82 = tick();
    end);
    u86 = Event2:Connect(function() -- Line: 571
...
function v26.disableCameraToggleInput() -- Line: 579
