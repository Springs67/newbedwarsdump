...
return {
    ProgressBar = v2.new(u1)(function(u3, p4) -- Line: 7
        ...
        useEffect(function() -- Line: 16
            ...
            TweenService:Create(v8, TweenInfo.new(BarTweenSpeed == nil and 0.12 or BarTweenSpeed, Enum.EasingStyle.Linear), {
        ...
        useEffect(function() -- Line: 27
            ...
            local BarTweenSpeed = u3.BarTweenSpeed;
            TweenService:Create(v9, TweenInfo.new(BarTweenSpeed == nil and 0.012 or BarTweenSpeed, Enum.EasingStyle.Linear), {
                Size = u3.Size
            }):Play();
        end, { u3.Size });
        local v10 = {
