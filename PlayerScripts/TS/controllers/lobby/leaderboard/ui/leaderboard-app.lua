...
local v3 = u1.PureComponent:extend("LeaderBoardAppBase");

function v3.init(p4) -- Line: 9
end;

function v3.render(p5) -- Line: 11
    -- upvalues: u1 (copy), LeaderboardCore (copy)
    local v6 = {
        LightInfluence = 0.25,
    ...
    v9[#v9 + 1] = u1.createElement(LeaderboardCore, v10);
...
return {
    LeaderboardApp = v2.connect(function(p11, p12) -- Line: 36
        local v13 = {
            store = p11
        };
