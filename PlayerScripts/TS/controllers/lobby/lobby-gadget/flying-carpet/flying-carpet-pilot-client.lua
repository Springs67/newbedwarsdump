...
local MountFlightControls = RuntimeLib.import(script, script.Parent.Parent.Parent.Parent, "global", "mount", "mount-flight-controls").MountFlightControls;
local VehicleClient = RuntimeLib.import(script, script.Parent.Parent.Parent.Parent, "global", "vehicle", "vehicle-client").VehicleClient;
...
local function map(p9, p10, p11, p12, p13) -- Line: 32
...
function u14.constructor(u16, u17) -- Line: 49
    ...
    if CurrentCamera then
        ...
        u16.maid:GiveTask(function() -- Line: 86
    ...
    u16.maid:GiveTask(function() -- Line: 100
        -- upvalues: u18 (copy)
        u18:Destroy();
    end);
    ...
    u16.maid:GiveTask(function() -- Line: 109
        -- upvalues: u16 (copy)
    ...
    u16.maid:GiveTask(function() -- Line: 119
        -- upvalues: u16 (copy)
    ...
    u16.maid:GiveTask(function() -- Line: 129
        -- upvalues: u16 (copy)
    ...
    u16.maid:GiveTask(RunService.Stepped:Connect(function(p19, p20) -- Line: 153
    ...
    u16.maid:GiveTask(v55.shouldFlyUpRef.Changed:Connect(function(p56) -- Line: 249
        -- upvalues: u16 (copy)
        u16.holdingUp = p56;

        return u16.holdingUp;
    end));
    u16.maid:GiveTask(v55.shouldFlyDownRef.Changed:Connect(function(p57) -- Line: 253
        -- upvalues: u16 (copy)
        u16.holdingDown = p57;

        return u16.holdingDown;
    end));
    SoundManager:playSound(RandomUtil.fromList(GameSound.FLYING_CARPET_DEPLOY), {
        position = nil
    });
    u16.maid:GiveTask(ClientSyncEvents.MoveMountButtonChange:connect(function(p58) -- Line: 261
    ...
    local u59 = u4.mount(u4.createElement("ScreenGui", {
        ResetOnSpawn = false
    }, { u4.createElement(MoveMountUI) }), Players.LocalPlayer:WaitForChild("PlayerGui"));
    u16.maid:GiveTask(function() -- Line: 285
        -- upvalues: u4 (ref), u59 (copy)
        u4.unmount(u59);
    end);
end;

function u14.onDisable(p60) -- Line: 290
    p60.maid:DoCleaning();
