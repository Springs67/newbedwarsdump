...
local v20 = v4.new(u3)(function(u6, p7) -- Line: 15
    ...
    v15.SnowboardingMinigameAnnouncementFrame = createElement("Frame", v16, {
    ...
    v15.SnowboardingMinigameCountdownGuiFrame = u3.createElement("Frame", v18, {
    ...
    return u3.createFragment({
        SnowboardingMinigameCountdownGui = u3.createElement("ScreenGui", v14, v15)
    });
end);

return {
    SnowboardingMinigameCountdownGUI = v5.connect(function(p21, p22) -- Line: 140
        local v23 = {};
