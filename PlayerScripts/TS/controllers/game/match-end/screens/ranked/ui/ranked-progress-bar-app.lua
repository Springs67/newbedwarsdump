...
local v3 = u1.PureComponent:extend("RankedProgressBarAppBase");

function v3.init(p4) -- Line: 9
end;

function v3.render(p5) -- Line: 11
    -- upvalues: u1 (copy), RankedProgressBarCore (copy)
    local v6 = {};
    local v7 = {};
    local v8 = {
        ResetOnSpawn = false,
    ...
    v6[#v6 + 1] = u1.createElement(RankedProgressBarCore, v7);

    return u1.createElement("ScreenGui", v8, v6);
end;

return {
    RankedProgressBarApp = v2.connect(function(p9, p10) -- Line: 26
        local v11 = {
            store = p9
        };
