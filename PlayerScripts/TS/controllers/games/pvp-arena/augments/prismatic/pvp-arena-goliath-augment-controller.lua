...
local u1 = setmetatable({}, {
    __tostring = function() -- Line: 12, Name: __tostring
        return "PvPArenaGoliathAugmentController";
    end,
...
function u1.constructor(p3) -- Line: 22
    ...
    PvPArenaBaseAugmentController.constructor(p3, PvPArenaAugmentType.GOLIATH);
    p3.Name = "PvPArenaGoliathAugmentController";
    p3.hasAugment = false;
end;
...
function u1.onGameInit(u4) -- Line: 27
    ...
    WatchCharacter(function(p5) -- Line: 29
        ...
        if p5 == Players.LocalPlayer and u4.hasAugment then
            u4:addSpeedModifier();
        end;
    end);
end;
...
function u1.addSpeedModifier(p7) -- Line: 39
    ...
    p7.speedModifier = {
        blockSprint = false,
        moveSpeedMultiplier = p7.config.walkSpeedMultiplier
    };
