...
local PlacementHud = RuntimeLib.import(script, script.Parent, "placement-hud").PlacementHud;

return function(p3) -- Line: 10
    -- upvalues: OfflinePlayerUtil (copy), u2 (copy), GameReducer (copy), u1 (copy), StoreProvider (copy), PlacementHud (copy), QueueType (copy)
    local v4 = {
        {
            id = "1",
            name = "Red",
    ...
    local u6 = u1.mount(u1.createElement(StoreProvider, {
        store = v5
    }, { u1.createElement(PlacementHud, {
            AppId = "PlacementHud",
            queueType = QueueType.ONE_IN_THE_CHAMBER
        }) }), p3);
