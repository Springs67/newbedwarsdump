...
return {
    SteamEngineerDisplay = v2.new(u1)(function(p3, p4) -- Line: 6
        -- upvalues: u1 (copy), GatherBotBalance (copy)
        local _ = p4.useState;
        ...
        return u1.createElement("Frame", {
            ...
            u1.createElement("Frame", {
                ...
                u1.createElement("TextLabel", {
                    ...
                    Text = tostring(p3.gatherBotBasicAmount) .. "/" .. tostring(GatherBotBalance.GATHER_BOT_MAX_AMOUNT),
                ...
                u1.createElement("TextLabel", {
                    ...
                    BackgroundTransparency = 1,
                    Size = UDim2.fromScale(0.7, 0.7),
                    Text = tostring(p3.gatherBotProAmount) .. "/" .. tostring(GatherBotBalance.GATHER_BOT_MAX_AMOUNT),
                    TextColor3 = Color3.fromRGB(255, 255, 255)
                }, { u1.createElement("UIAspectRatioConstraint", {
                        AspectRatio = 1.3
                    }) })
