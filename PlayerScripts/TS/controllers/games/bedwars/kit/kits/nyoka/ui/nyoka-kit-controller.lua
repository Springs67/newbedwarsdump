...
local BaseKitController = RuntimeLib.import(script, script.Parent.Parent.Parent.Parent, "base-kit-controller").BaseKitController;
local u1 = setmetatable({}, {
    __tostring = function() -- Line: 10, Name: __tostring
        return "NyokaKitController";
    end,
...
function u1.constructor(p3) -- Line: 20
    ...
    BaseKitController.constructor(p3, BedwarsKit.NYOKA);
    p3.Name = "NyokaKitController";
end;
