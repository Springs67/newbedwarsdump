...
local v24 = v3.new(u2)(function(p5, p6) -- Line: 15
    -- upvalues: HalloweenUpgradeType (copy), default (copy), SoundManager (copy), GameSound (copy), u2 (copy), BedwarsImageId (copy), HalloweenLevelConfig (copy), CircularProgress (copy), HalloweenAbilityTreeChoiceArea (copy)
    local useState = p6.useState;
    local useEffect = p6.useEffect;
    local v7, u8 = useState(1);
    local v9, u10 = useState(0);
    local v11, u12 = useState(false);
    local v13, u14 = useState(HalloweenUpgradeType.DAMAGE_INCREASE);
    local v15, u16 = useState(HalloweenUpgradeType.DAMAGE_INCREASE);
    useEffect(function() -- Line: 23
        ...
        default.Client:GetNamespace("Halloween2025Remotes"):Get("PlayerLevelUp"):Connect(function(p17) -- Line: 24
        ...
        default.Client:GetNamespace("Halloween2025Remotes"):Get("ExperienceProgress"):Connect(function(p18) -- Line: 35
            -- upvalues: u10 (ref)
            u10(p18.experience);
        end);
    end, { v9 });
