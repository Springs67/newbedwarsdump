...
return {
    KitShopVariantSelect = v4.new(u3)(function(u5, p6) -- Line: 13
        -- upvalues: BedwarsKitSkinMeta (copy), u2 (copy), DeviceUtil (copy), KnitClient (copy), BedwarsKit (copy), ClientStore (copy), u3 (copy), DropdownComponent (copy)
        local _ = p6.useState;
        local SelectedSkin = u5.SelectedSkin;
        local variantOfSkin = BedwarsKitSkinMeta[SelectedSkin].variantOfSkin;
        ...
        if variantOfSkin ~= nil then
            SelectedSkin = variantOfSkin;
        end;

        local function _(p7) -- Line: 26
            -- upvalues: SelectedSkin (copy)
            local _ = p7[1];
            ...
            return variantOfSkin2 == SelectedSkin;
        end;
        ...
        for i, v in u2.entries(BedwarsKitSkinMeta) do
            ...
            if variantOfSkin2 == SelectedSkin == true then
                v8 = v8 + 1;
                v9[v8] = v;
            end;
        end;

        table.sort(v9, function(p10, p11) -- Line: 45
        ...
        local function v16(p12) -- Line: 58
            -- upvalues: SelectedSkin (copy), DeviceUtil (ref), u5 (copy), KnitClient (ref)
            local v13 = p12[1];
            local v14 = p12[2];
            ...
            if variantOfSkin2 == SelectedSkin then
                local v15;
        ...
        local function _(p20) -- Line: 87
            -- upvalues: u5 (copy)
            return p20.value == u5.SelectedSkin;
        end;
        ...
        for i, v in v18 do
            ...
            if v.value == u5.SelectedSkin == true then
                v21 = v;
                break;
            end;
        end;
        ...
        if not v21 then
            local function _(p22) -- Line: 101
                -- upvalues: SelectedSkin (copy)
                return p22.value == SelectedSkin;
            end;
            ...
            for i, v in v18 do
                ...
                if v.value == SelectedSkin == true then
                    v21 = v;
                    break;
                end;
            end;
        ...
        function v23.OnItemSelected(p24) -- Line: 125
        ...
        return u3.createFragment({
            KitShopVariantSelectDropdownComponent = u3.createElement(DropdownComponent, v23)
        });
    end)
};