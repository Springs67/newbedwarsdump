...
return {
    KitShopReadLoreButton = v3.new(u2)(function(u4, p5) -- Line: 15
        -- upvalues: BedwarsKit (copy), u2 (copy), Button (copy), Flamework (copy), BedwarsAppIds (copy), DeviceUtil (copy), BedwarsImageId (copy), TooltipContainer (copy), AutoSizedText (copy), getBedwarsKitMeta (copy)
        local _ = p5.useState;
        ...
        return u2.createFragment({
            ReadLoreButton = u2.createElement(Button, {
                ...
                u2.createElement("ImageLabel", {
                    ...
                    Image = BedwarsImageId.BOOK_SOLID,
