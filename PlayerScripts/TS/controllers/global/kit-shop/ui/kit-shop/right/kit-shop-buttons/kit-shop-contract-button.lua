...
return {
    KitShopContractButton = v3.new(u2)(function(u4, p5) -- Line: 16
        -- upvalues: BedwarsKit (copy), u2 (copy), Button (copy), Flamework (copy), BedwarsAppIds (copy), ColorUtil (copy), DeviceUtil (copy), BedwarsImageId (copy), TooltipContainer (copy), AutoSizedText (copy), getBedwarsKitMeta (copy)
        local _ = p5.useState;
        ...
        return u2.createFragment({
            ContractButton = u2.createElement(Button, {
