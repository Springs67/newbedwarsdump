...
return {
    FlyingBroomUi = v4.new(u3)(function(u5, p6) -- Line: 13
        -- upvalues: u2 (copy), DeviceUtil (copy), KnitClient (copy), Flamework (copy), u3 (copy), MoveMountUI (copy), ProgressBar (copy), Theme (copy)
        ...
        useEffect(function() -- Line: 18
            ...
            local u11 = u2.new();
            u11:GiveTask(u5.vehicleModel:GetAttributeChangedSignal("Health"):Connect(function() -- Line: 20
                -- upvalues: u8 (ref), u5 (ref)
                u8(u5.vehicleModel:GetAttribute("Health"));
            end));
            u11:GiveTask(u5.vehicleModel:GetAttributeChangedSignal("MaxHealth"):Connect(function() -- Line: 23
