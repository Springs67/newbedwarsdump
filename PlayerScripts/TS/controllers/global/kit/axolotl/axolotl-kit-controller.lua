...
function u1.constructor(p3) -- Line: 20
    ...
    BaseKitController.constructor(p3, BedwarsKit.AXOLOTL);
    p3.Name = "AxolotlKitController";
end;
...
function u1.onKitLocalActivated(p5, p6) -- Line: 27
    ...
    KnitClient.Controllers.PreloadController:runPreload({
        imageIds = { "rbxassetid://7863780357", "rbxassetid://7863780231", "rbxassetid://7863779927", "rbxassetid://7863780097" }
    });
end;
