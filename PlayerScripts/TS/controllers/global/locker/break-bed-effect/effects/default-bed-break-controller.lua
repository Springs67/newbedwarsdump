...
function u1.constructor(p3) -- Line: 20
    ...
    BreakBedEffectController.constructor(p3, BedBreakEffectType.NONE);
    p3.Name = "DefaultBedBreakController";
end;

function u1.KnitStart(p4) -- Line: 24
    -- upvalues: BreakBedEffectController (copy)
    BreakBedEffectController.KnitStart(p4);
end;

function u1.onBedBreak(p5, p6, p7, p8) -- Line: 27
end;
