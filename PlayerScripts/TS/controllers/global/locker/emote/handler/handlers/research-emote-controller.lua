...
function u1.constructor(p3) -- Line: 24
    ...
    p3.Name = "ResearchEmoteController";
end;
...
function u1.KnitStart(p4) -- Line: 28
    ...
    local BOOK_READ = EmoteType.BOOK_READ;
    ...
    function u6.onEnable(p9, p10, p11, p12, p13) -- Line: 49
        ...
        local u14 = ReplicatedStorage.Assets.Misc.MageSpellbook:Clone();
        u14.Parent = p11;
    ...
    EmoteHandlerController:registerHandler(BOOK_READ, u6);
end;
