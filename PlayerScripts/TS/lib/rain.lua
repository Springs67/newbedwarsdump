...
local u32 = { Part };
local u45 = {
    [u11.None] = function(p33, p34) -- Line: 393
    ...
    [u11.Blacklist] = function(p36) -- Line: 396
        -- upvalues: u22 (ref)
        return workspace:FindPartOnRayWithIgnoreList(p36, u22);
    end,

    [u11.Whitelist] = function(p37) -- Line: 399
        -- upvalues: u22 (ref)
        return workspace:FindPartOnRayWithWhitelist(p37, u22);
    end,

    [u11.Function] = function(p38) -- Line: 402
        -- upvalues: u32 (copy), u20 (ref)
...
local function connectLoop() -- Line: 417
    -- upvalues: u23 (ref), RunService (copy), u46 (ref), u18 (ref), u21 (ref), u15 (ref), u19 (ref), TweenService (copy), Sound (copy), Part (ref), new (copy), u12 (copy), u24 (ref), u13 (copy), u25 (ref), u28 (ref), u14 (copy), u16 (ref), u29 (ref), u17 (ref)
    local u47 = Random.new();
    local u48 = true;
    local u49 = 6;
    table.insert(u23, RunService.RenderStepped:connect(function() -- Line: 425
        -- upvalues: u46 (ref), u18 (ref), u21 (ref), u15 (ref), u19 (ref), TweenService (ref), Sound (ref), u49 (ref), Part (ref), new (ref), u48 (ref)
        local v50, _ = u46(Ray.new(workspace.CurrentCamera.CFrame.p, -u18 * 1000), true);

        if u21 and workspace.CurrentCamera.CFrame.p.y > u21 or v50 then
    ...
    table.insert(u23, v55:connect(function() -- Line: 484
        -- upvalues: u49 (ref), u18 (ref), u12 (ref), u24 (ref), u13 (ref), u25 (ref), u48 (ref), u28 (ref), u19 (ref), u21 (ref), u14 (ref), u46 (ref), u15 (ref), TweenService (ref), Sound (ref), Part (ref), u16 (ref), u29 (ref), u47 (copy), new (ref), u17 (ref)
        u49 = u49 + 1;
        ...
        if u49 >= 6 then
            ...
            local v58 = NumberSequence.new({
                u12,
                NumberSequenceKeypoint.new(0.25, (1 - v57) * u24 + v57, 0),
                NumberSequenceKeypoint.new(0.75, (1 - v57) * u24 + v57, 0),
                u13
            });
            local v59 = NumberSequence.new({
                u12,
                NumberSequenceKeypoint.new(0.25, v57 * u25 + (1 - v57), 0),
                NumberSequenceKeypoint.new(0.75, v57 * u25 + (1 - v57), 0),
                u13
            });
            ...
            if u48 then
                ...
                if not u19 then
                    ...
                    if u21 and workspace.CurrentCamera.CFrame.p.y > u21 then
                        v63 = 0;
                    else
                        local v64 = -u18 * 1000;
                        local v65 = 35;
        ...
        for i = 1, u16 do
            ...
            if v74 then
                ...
                if u48 then
                    ...
                    if u21 and (u21 < v77.Y and u18.Y < 0) then
                        v77 = v77 + u18 * (u21 - v77.Y) / u18.Y;
                    end;
            ...
            elseif u48 then
                ...
                if u21 and (u21 < v78.Y and u18.Y < 0) then
                    v78 = v78 + u18 * (u21 - v78.Y) / u18.Y;
                end;
...
local function disconnectLoop() -- Line: 629
    -- upvalues: u23 (ref)
    if #u23 > 0 then
...
local function disable() -- Line: 654
...
local function makeProperty(p82, p83, p84) -- Line: 671
...
local function v88(p86) -- Line: 681
...
local function updateTransparency(p89) -- Line: 698
    -- upvalues: NumberValue (copy), u24 (ref), u25 (ref), u12 (copy), u13 (copy), u29 (ref)
...
local function v94(p93) -- Line: 721
    -- upvalues: Part (ref)
...
local function v96(p95) -- Line: 728
    -- upvalues: Part (ref), u17 (ref), u16 (ref)
...
local function v98(p97) -- Line: 738
...
local function v100(p99) -- Line: 753
    -- upvalues: Part (ref), u28 (ref), u29 (ref)
...
local function v102(p101) -- Line: 767
    -- upvalues: u18 (ref)
...
local v112 = {
    ...
    Enable = function(p103, p104) -- Line: 780, Name: Enable
    ...
    Disable = function(p105, p106) -- Line: 818, Name: Disable
        ...
        if p106 then
            ...
            u107.Completed:connect(function(p108) -- Line: 826
    ...
    SetColor = function(p109, p110, p111) -- Line: 845, Name: SetColor
...
local function makeRatioSetter(u113, u114) -- Line: 861
    -- upvalues: TweenService (copy)
    return function(p115, p116, p117) -- Line: 863
...
function v112.SetTransparency(p120, p121, p122) -- Line: 863
...
function v112.SetSpeedRatio(p125, p126, p127) -- Line: 863
...
function v112.SetIntensityRatio(p130, p131, p132) -- Line: 863
...
function v112.SetLightEmission(p135, p136, p137) -- Line: 863
...
function v112.SetLightInfluence(p140, p141, p142) -- Line: 863
...
function v112.SetVolume(p144, p145, p146) -- Line: 888
...
function v112.SetDirection(p147, p148, p149) -- Line: 904
...
function v112.SetCeiling(p150, p151) -- Line: 925
    -- upvalues: u21 (ref)
...
function v112.SetStraightTexture(p152, p153) -- Line: 935
...
function v112.SetTopDownTexture(p154, p155) -- Line: 949
    -- upvalues: Part (ref), u28 (ref)
...
function v112.SetSplashTexture(p156, p157) -- Line: 963
    -- upvalues: u29 (ref)
...
function v112.SetSize(p158, p159) -- Line: 975
    -- upvalues: Part (ref), u28 (ref)
    Part.RainStraight.Size = NumberSequence.new(p159);

    for _, v in pairs(u28) do
        v.RainStraight.Size = NumberSequence.new(p159);
    end;
end;

function v112.SetSoundId(p160, p161) -- Line: 983
    -- upvalues: Sound (copy)
    if typeof(p161) ~= "string" then
        error("bad argument #1 to \'SetSoundId\' (string expected, got " .. typeof(p161) .. ")", 2);
    end;

    Sound.SoundId = p161;
end;

function v112.SetCollisionMode(p162, p163, p164) -- Line: 993
    -- upvalues: u11 (copy), u22 (ref), u20 (ref), Part (ref), None (ref), u46 (ref), u45 (copy)
    if p163 == u11.None then
        u22 = nil;
        u20 = nil;
    elseif p163 == u11.Blacklist then
        if typeof(p164) == "Instance" then
            u22 = { p164, Part };
        elseif typeof(p164) == "table" then
            for i = 1, #p164 do
                if typeof(p164[i]) ~= "Instance" then
                    error("bad argument #2 to \'SetCollisionMode\' (blacklist contained a " .. typeof(p164[i]) .. " on index " .. tostring(i) .. " which is not an Instance)", 2);
                end;
            end;
            ...
            for i = 1, #p164 do
                table.insert(u22, p164[i]);
            end;
        else
            error("bad argument #2 to \'SetCollisionMode (Instance or array of Instance expected, got " .. typeof(p164) .. ")\'", 2);
        end;

        u20 = nil;
    elseif p163 == u11.Whitelist then
        if typeof(p164) == "Instance" then
            u22 = { p164 };
        elseif typeof(p164) == "table" then
            for i = 1, #p164 do
                if typeof(p164[i]) ~= "Instance" then
                    error("bad argument #2 to \'SetCollisionMode\' (whitelist contained a " .. typeof(p164[i]) .. " on index " .. tostring(i) .. " which is not an Instance)", 2);
                end;
            end;
        ...
        u20 = nil;
    elseif p163 == u11.Function then
        if typeof(p164) ~= "function" then
            error("bad argument #2 to \'SetCollisionMode\' (function expected, got " .. typeof(p164) .. ")", 2);
        end;

        u22 = nil;
        u20 = p164;
    else
        error("bad argument #1 to \'SetCollisionMode (Rain.CollisionMode expected, got " .. typeof(p164) .. ")\'", 2);
    end;
