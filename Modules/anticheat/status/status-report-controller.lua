...
local KnitController = RuntimeLib.import(script, script.Parent.Parent.Parent.Parent, "TS", "lib", "knit", "knit-controller").KnitController;
...
function u1.constructor(p3, ...) -- Line: 19
    ...
    p3.Name = "StatusReportController";
end;
