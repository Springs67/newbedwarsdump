...
local u4 = v1.import(script, script.Parent, "leaderboard-core").LeaderboardCore
local v5 = u2.PureComponent:extend("LeaderBoardAppBase")
...
return {
    ["LeaderboardApp"] = v3.connect(function(p16, p17) --[[ Line: 36 ]]
        local v18 = {
            ["store"] = p16
        }
