...
function u5.constructor(p8) --[[ Line: 20 ]]
    ...
    --]]
    u3.constructor(p8)
    p8.Name = "EventShopContoller"
    p8.eventRemotes = u4.Client:GetNamespace("Event")
end
...
function u5.purchaseItem(p10, p11, p12) --[[ Line: 28 ]]
    return p10.eventRemotes:Get("PurchaseShopItem"):CallServer(p11, p12)
end
