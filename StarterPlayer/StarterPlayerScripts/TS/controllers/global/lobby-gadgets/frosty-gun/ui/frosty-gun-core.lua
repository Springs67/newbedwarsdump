...
local u9 = v1.import(script, script.Parent, "frosty-gun-ability-button").FrostyGunButton
return {
    ["FrostyGunCore"] = v7.new(u6)(function(p10, p11) --[[ Line: 11 ]]
        --[[
        Upvalues:
            [1] = u4
            [2] = u2
        ...
        return u6.createFragment({
            ["FrostGunAbilityBar"] = u6.createElement("Frame", v29, v32)
        })
    end)
}