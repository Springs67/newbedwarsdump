...
local u10 = v1.import(script, script.Parent, "ui", "tier-upgrade-notification-popup").TierUpgradeNotificationPopup
...
function u11.constructor(p14) --[[ Line: 26 ]]
    ...
    --]]
    u6.constructor(p14)
    p14.Name = "TierUpgradeNotificationController"
end
function u11.KnitStart(p15) --[[ Line: 30 ]]
    ...
    --]]
    u6.KnitStart(p15)
    u7.Client:Get("TierUpgradeNotification"):Connect(function(p16, p17) --[[ Line: 32 ]]
        --[[
        Upvalues:
            [1] = u9
            [2] = u3
