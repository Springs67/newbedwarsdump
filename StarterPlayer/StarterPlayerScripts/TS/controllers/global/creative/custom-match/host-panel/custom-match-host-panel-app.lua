...
local u8 = v1.import(script, script.Parent, "custom-match-host-panel-core").CustomMatchHostPanel
local v9 = u6.PureComponent:extend("CustomMatchHostPanelBase")
...
return {
    ["CustomMatchHostPanelApp"] = v7.connect(function(p11, p12) --[[ Line: 33 ]]
        local v13 = {
            ["store"] = p11
        }
