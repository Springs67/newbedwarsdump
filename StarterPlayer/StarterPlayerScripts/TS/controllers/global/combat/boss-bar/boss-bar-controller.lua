...
function u8.updateHealth(_, p25, p26) --[[ Line: 56 ]]
    --[[
    Upvalues:
        [1] = u6
    --]]
    local v27 = p25 < 0 and 0 or p25
    if p26 == 0 or (p26 ~= p26 or not p26) then
        u6:dispatch({
...
function u8.unmountBar(p28) --[[ Line: 73 ]]
    --[[
    Upvalues:
        [1] = u2
        [2] = u7
