...
local u4 = v1.import(script, script.Parent, "hotbar-party-member").HotbarPartyMember
local v5 = u3.Component:extend("HotbarPartyMemberList")
...
function v5.render(p6) --[[ Line: 11 ]]
    ...
    Upvalues:
        ...
        [3] = u4
    --]]
    local v7 = { p6.props.store.Party.leader }
    local v8 = #v7
    local v9 = p6.props.store.Party.members
    table.move(v9, 1, #v9, v8 + 1, v7)
    if #v7 == 1 then
    ...
    for v11, v12 in v7 do
        ...
        v10[v11] = u3.createElement(u4, v13)
    end
    local v14 = {
    ...
    local v15 = { u3.createElement("UIGridLayout", {
    ...
    return u3.createElement("Frame", v14, v15)
end
return {
    ["HotbarPartyMemberList"] = v5
}