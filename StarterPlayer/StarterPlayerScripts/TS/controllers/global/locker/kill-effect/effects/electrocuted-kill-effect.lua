...
function u12.onKill(p17, _, p18, p19) --[[ Line: 31 ]]
    ...
    u2:playSound(u9.WIZARD_LIGHTNING_CAST, {
        ["position"] = p19.Position
    })
    local v25 = u6.Assets.Effects.ElektraKillEffect:Clone()
    v25:PivotTo(p19)
    v25.Parent = u7
    u20:GiveTask(v25)
...
function u12.fade(_, p26, u27, u28) --[[ Line: 76 ]]
    --[[
    Upvalues:
        [1] = u8
        [2] = u3
    --]]
    local function v31(u29) --[[ Line: 78 ]]
        --[[
        Upvalues:
            [1] = u28
            [2] = u8
        ...
        if u29:IsA("BasePart") then
            if u28 ~= 0 and (u28 == u28 and u28) then
                u8(u28, u3, function(p30) --[[ Line: 81 ]]
                    --[[
                    Upvalues:
                        [1] = u29
                    --]]
