...
function u13.constructor(p16) --[[ Line: 28 ]]
    ...
    Upvalues:
        ...
        [2] = u9
    --]]
    u12.constructor(p16, u9.BUTTERFLY_EXPLOSION)
    p16.Name = "ButterflyExplosionBedBreakEffectController"
end
...
function u13.createEffect(u22, p23, _, p24) --[[ Line: 40 ]]
    ...
    local v32 = u6.Assets.Effects.AeryBedEffect:Clone()
    v32:PivotTo(p23)
    v32.Parent = u7
    u22.maid:GiveTask(v32)
    u11:playInstanceEffects({ v32 }, {
        ["destroyAfterSec"] = 4
    })
    local v33 = u2:playSound(u10.AERY_BUTTERFLY_SOUND_EFFECT, {
        ["position"] = p23.Position
    })
    u22.maid:GiveTask(v33)
    u22.maid:GiveTask(task.delay(4, function() --[[ Line: 87 ]]
        --[[
        Upvalues:
            [1] = u22
        --]]
