...
return {
    ["CoinTossResult"] = v6.new(u5)(function(p8, p9) --[[ Line: 9 ]]
        --[[
        Upvalues:
            [1] = u5
            [2] = u4
        ...
        v10(function() --[[ Line: 13 ]]
            ...
            task.delay(1.5, function() --[[ Line: 34 ]]
                ...
                Upvalues:
                    ...
                    [5] = u5
                --]]
                local u16 = u3.Controllers.CoinTossHandlerController.guiTree
                if u16 then
                    u14:Play()
                    u15:Play()
        ...
        v21.CoinTossEmoteResult = v22("Frame", v23, v24)
        v18.CoinTossEmoteGui = v19("BillboardGui", v20, v21)
        return v17(v18)
    end)
}