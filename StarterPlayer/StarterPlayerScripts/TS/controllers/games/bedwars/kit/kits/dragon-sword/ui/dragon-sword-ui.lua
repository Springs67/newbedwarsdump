...
return {
    ["DragonSwordUIDisplay"] = v5.new(u4)(function(u7, p8) --[[ Line: 8 ]]
        --[[
        Upvalues:
            [1] = u3
            [2] = u6
        ...
        v21[v25] = v26("TextLabel", v27, { u4.createElement("UIAspectRatioConstraint", {
                ["AspectRatio"] = 1.3
            }) })
        v21[v22 + 3] = u4.createElement("TextLabel", {
            ["BackgroundTransparency"] = 1,
            ["BorderSizePixel"] = 0,
            ["Font"] = "LuckiestGuy",
            ["TextYAlignment"] = "Center",
