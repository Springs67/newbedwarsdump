...
local u7 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "attributes").SpiritGardenerEnergyAttr
local u8 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "games", "bedwars", "kit", "kits", "spirit-gardener", "spirit-gardener-balance").SpiritGardenerKitBalance
local u9 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "util", "typesafe-attributes").GetAttribute
return {
    ["SpiritGardenerEnergyUi"] = v5.new(u4)(function(_, p10) --[[ Line: 11 ]]
        --[[
        Upvalues:
            [1] = u4
            [2] = u3
