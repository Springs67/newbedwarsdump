...
local u5 = v1.import(script, script.Parent, "necromancer-staff-core").NecromancerStaffCore
local v14 = v3.new(u2)(function(p6, p7) --[[ Line: 7 ]]
    ...
    return u2.createFragment({
        ["NecromancerStaffGUI"] = u2.createElement("ScreenGui", v11, v8)
    })
end)
return {
    ["NecromancerStaffUiBase"] = v4.connect(function(p15, p16) --[[ Line: 24 ]]
        local v17 = {}
        for v18, v19 in p16 do
            v17[v18] = v19
        end
        v17.activeMode = p15.Kit.necromancerSummonType
        return v17
    end)(v14)
}