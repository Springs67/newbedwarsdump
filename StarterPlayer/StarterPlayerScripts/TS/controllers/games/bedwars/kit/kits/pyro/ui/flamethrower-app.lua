...
local u11 = v1.import(script, script.Parent, "flamethrower-component").FlamethrowerComponent
local v12 = u6.Component:extend("FlamethrowerUpgradeAppBase")
...
function v12.render(p13) --[[ Line: 18 ]]
    ...
    Upvalues:
        ...
        [8] = u11
    --]]
    local v14 = u9.getToolFromInventory(u8.LocalPlayer, u10.FLAMETHROWER)
    if v14 ~= nil then
        v14 = v14.tool
    end
...
return {
    ["FlamethrowerUpgradeApp"] = v7.connect(function(_, p28) --[[ Line: 51 ]]
        return p28
    end)(v12)
}