...
local v9 = u5.Component:extend("EngineerCameraExit")
...
function v9.didMount(u15) --[[ Line: 80 ]]
    ...
    v16:BindAction("engineer-camera-exit", function(_, p18, _) --[[ Line: 81 ]]
        --[[
        Upvalues:
            [1] = u15
        --]]
    ...
    u15.maid:GiveTask(function() --[[ Line: 86 ]]
        ...
        Upvalues:
            [1] = u6
        --]]
        u6:UnbindAction("engineer-camera-exit")
    end)
end
