...
local u4 = v1.import(script, script.Parent.Parent.Parent.Parent, "base-kit-controller").BaseKitController
...
function u5.constructor(p8) --[[ Line: 20 ]]
    ...
    Upvalues:
        ...
        [2] = u3
    --]]
    u4.constructor(p8, u3.NYOKA)
    p8.Name = "NyokaKitController"
end
