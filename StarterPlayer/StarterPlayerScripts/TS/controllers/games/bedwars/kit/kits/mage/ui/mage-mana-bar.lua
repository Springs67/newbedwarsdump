...
local u7 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "attributes").ManaAttr
local u8 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "games", "bedwars", "kit", "kits", "mage", "mage-kit-util").MAGE_MAX_MANA
local u9 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "util", "typesafe-attributes").GetAttribute
return {
    ["MageManaBar"] = v5.new(u4)(function(_, p10) --[[ Line: 11 ]]
        --[[
        Upvalues:
            [1] = u4
            [2] = u3
