...
function u9.constructor(p12) --[[ Line: 24 ]]
    ...
    Upvalues:
        ...
        [2] = u6
    --]]
    u8.constructor(p12, u6.TRIXIE)
    p12.Name = "PvPArenaTrixieAugmentController"
end
function u9.onActivated(_) --[[ Line: 28 ]]
    ...
    Upvalues:
        ...
        [5] = u7
    --]]
    u3.Controllers.PvpArenaAugmentAbilityController:registerAbilities({ u5.VOID_WALKER_WARP, u5.VOID_WALKER_REWIND })
    local v13 = u3.Controllers.PvpArenaAugmentAbilityController:getAbilityType(u5.VOID_WALKER_WARP)
    local u14 = u3.Controllers.PvpArenaAugmentAbilityController:getAbilityType(u5.VOID_WALKER_REWIND)
    if not (v13 and u14) then
        return nil
    end
    u3.Controllers.VoidWalkerKitController:add(u4.LocalPlayer)
    u3.Controllers.VoidWalkerKitController:initKit(u4.LocalPlayer)
    u2.resolveDependency("@easy-games/game-core:client/controllers/ability/ability-controller@AbilityController"):disableAbility(u5.VOID_WALKER_WARP)
    u2.resolveDependency("@easy-games/game-core:client/controllers/ability/ability-controller@AbilityController"):disableAbility(u5.VOID_WALKER_REWIND)
    local v15 = u2.resolveDependency("@easy-games/game-core:client/controllers/ability/ability-controller@AbilityController")
    local v16 = u5.VOID_WALKER_WARP
    local v17 = {
        ["abilityButton"] = {
            ["icon"] = u7.VOID_WALKER_WARP_ICON1
        },
        ["abilityType"] = v13
    }
    v15:enableAbility(v16, v17):andThen(function() --[[ Line: 45 ]]
        ...
        local v19 = u5.VOID_WALKER_REWIND
        local v20 = {
            ["abilityButton"] = {
                ["icon"] = u7.VOID_WALKER_REWIND_ICON
            },
            ["abilityType"] = u14
        }
