...
function u9.constructor(p12) --[[ Line: 24 ]]
    ...
    Upvalues:
        ...
        [2] = u6
    --]]
    u8.constructor(p12, u6.TERRA_KICK)
    p12.Name = "PvPArenaTerraAugmentController"
end
function u9.onActivated(_) --[[ Line: 28 ]]
    ...
    Upvalues:
        ...
        [5] = u7
    --]]
    u3.Controllers.PvpArenaAugmentAbilityController:registerAbilities({ u5.BLOCK_STOMP, u5.BLOCK_KICK })
    local v13 = u3.Controllers.PvpArenaAugmentAbilityController:getAbilityType(u5.BLOCK_STOMP)
    local u14 = u3.Controllers.PvpArenaAugmentAbilityController:getAbilityType(u5.BLOCK_KICK)
    if not (v13 and u14) then
        return nil
    end
    u3.Controllers.BlockKickerKitController:add(u4.LocalPlayer)
    u3.Controllers.BlockKickerKitController:initKit(u4.LocalPlayer)
    u2.resolveDependency("@easy-games/game-core:client/controllers/ability/ability-controller@AbilityController"):disableAbility(u5.BLOCK_STOMP)
    u2.resolveDependency("@easy-games/game-core:client/controllers/ability/ability-controller@AbilityController"):disableAbility(u5.BLOCK_KICK)
    local v15 = u2.resolveDependency("@easy-games/game-core:client/controllers/ability/ability-controller@AbilityController")
    local v16 = u5.BLOCK_STOMP
    local v17 = {
        ["abilityButton"] = {
            ["icon"] = u7.BLOCK_STOMP
        },
