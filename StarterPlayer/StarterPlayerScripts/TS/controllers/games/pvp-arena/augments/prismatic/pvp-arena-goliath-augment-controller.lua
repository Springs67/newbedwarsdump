...
function u7.constructor(p10) --[[ Line: 22 ]]
    ...
    Upvalues:
        ...
        [2] = u5
    --]]
    u6.constructor(p10, u5.GOLIATH)
    p10.Name = "PvPArenaGoliathAugmentController"
    p10.hasAugment = false
end
function u7.onGameInit(u11) --[[ Line: 27 ]]
    ...
    u2(function(p12) --[[ Line: 29 ]]
        ...
        Upvalues:
            ...
            [2] = u11
        --]]
        if p12 == u4.LocalPlayer and u11.hasAugment then
...
function u7.addSpeedModifier(p14) --[[ Line: 39 ]]
    ...
    p14.speedModifier = {
        ["blockSprint"] = false,
        ["moveSpeedMultiplier"] = p14.config.walkSpeedMultiplier
    }
