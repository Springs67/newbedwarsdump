...
function u6.constructor(p9) --[[ Line: 21 ]]
    ...
    Upvalues:
        ...
        [2] = u4
    --]]
    u5.constructor(p9, u4.COBALT)
    p9.Name = "PvPArenaCobaltAugmentController"
end
function u6.onActivated(_) --[[ Line: 25 ]]
    ...
    Upvalues:
        ...
        [2] = u3
    --]]
    u2.Controllers.BatteryController:add(u3.LocalPlayer)
    u2.Controllers.BatteryController:initKit(u3.LocalPlayer)
    u2.Controllers.BatteryEffectsController:add(u3.LocalPlayer)
    u2.Controllers.BatteryEffectsController:initKit(u3.LocalPlayer)
end
