...
function u6.constructor(p9) --[[ Line: 21 ]]
    ...
    Upvalues:
        ...
        [2] = u4
    --]]
    u5.constructor(p9, u4.SEAHORSE)
    p9.Name = "PvPArenaSeahorseAugmentController"
end
function u6.onActivated(_) --[[ Line: 25 ]]
    ...
    Upvalues:
        ...
        [2] = u3
    --]]
    u2.Controllers.SeahorseController:add(u3.LocalPlayer)
    u2.Controllers.SeahorseController:initKit(u3.LocalPlayer)
end
