...
local u13 = v1.import(script, script.Parent, "placement-score-card").PlacementScoreCard
local v67 = v7.new(u6)(function(u14, p15) --[[ Line: 16 ]]
    ...
    if v63 then
        ...
        v64.ShowMaxScore = u14.showMaxScore
    ...
    return u6.createFragment({
        ["PlacementScores"] = u6.createElement(u5, v57, v58)
    })
end)
return {
    ["PlacementScores"] = v8.connect(function(p68, p69) --[[ Line: 199 ]]
        local v70 = {}
        for v71, v72 in p69 do
            v70[v71] = v72
        end
        local v73 = p68.Game.teamScores
        table.sort(v73, function(p74, p75) --[[ Line: 206 ]]
            return p74.teamId < p75.teamId
        end)
        table.sort(v73, function(p76, p77) --[[ Line: 210 ]]
            if not p76 then
                return false
            end
            if not p77 then
