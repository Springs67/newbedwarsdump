...
local u8 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "games", "halloween-2024-event", "halloween-ability-type").HalloweenAbilityType
local u9 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "games", "halloween-2024-event", "halloween-level-config").HalloweenLevelConfig
...
local v34 = v6.new(u5)(function(_, p14) --[[ Line: 15 ]]
    ...
    local v23, u24 = v15(u8.DEATH_ADDER_COOLDOWN)
    local v25, u26 = v15(u8.DEATH_ADDER_COOLDOWN)
    v16(function() --[[ Line: 23 ]]
        ...
        Upvalues:
            ...
            [8] = u20
        --]]
        u11.Client:GetNamespace("Halloween2024Remotes"):Get("PlayerLevelUp"):Connect(function(p27) --[[ Line: 24 ]]
            --[[
            Upvalues:
                [1] = u4
                [2] = u12
        ...
        u11.Client:GetNamespace("Halloween2024Remotes"):Get("ExperienceProgress"):Connect(function(p28) --[[ Line: 35 ]]
            --[[
            Upvalues:
                [1] = u20
            --]]
    ...
    local v32 = {
        ...
        u5.createElement("ImageLabel", {
            ...
            ["ImageTransparency"] = 1 - v19 / u9.EXPERIENCE_NEEDED_PER_LEVEL
        }),
