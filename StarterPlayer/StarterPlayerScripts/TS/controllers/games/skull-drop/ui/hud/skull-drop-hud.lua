...
local u8 = v1.import(script, script.Parent, "skull-drop-event-timer").SkullDropEventTimer
local u9 = v1.import(script, script.Parent, "skull-drop-scores").SkullDropScores
local v15 = v6.new(u5)(function(_, p10) --[[ Line: 11 ]]
    --[[
    Upvalues:
        [1] = u5
        [2] = u4
    ...
    local v14 = {
        ["HunterLTMScoreHud"] = u5.createElement(u4, {
    ...
    v12.HunterLTMScoreHud = v13("ScreenGui", {
        ["ResetOnSpawn"] = false
    }, v14)
    return v11(v12)
end)
return {
    ["SkullDropHud"] = v7.connect(function(_, p16) --[[ Line: 41 ]]
        local v17 = {}
