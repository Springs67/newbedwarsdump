...
local u7 = v1.import(script, script.Parent, "skull-drop-hud").SkullDropHud
return function(p8) --[[ Line: 9 ]]
    ...
    __set_list(v9, 1, {v10, v11, v12, v13})
    ...
    local u19 = u3.mount(u3.createElement(u4, v18, { u3.createElement(u7, {
            ["AppId"] = "SkullDropHud"
        }) }), p8)
