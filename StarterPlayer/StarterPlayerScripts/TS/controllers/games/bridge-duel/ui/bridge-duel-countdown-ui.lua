...
local v37 = v10.new(u9)(function(u14, p15) --[[ Line: 15 ]]
    ...
    v30.ZIndex = v18
    v27.BridgeDuelRoundAnnouncementFrame = v28(v29, v30, {
    ...
    local v33
    if v19 then
        v33 = UDim2.fromScale(0.5, 0.27)
    else
        v33 = UDim2.fromScale(0.5, 0.2)
    end
    v32.Position = v33
    ...
    v32.ZIndex = v18
    v27.BridgeDuelRoundCountdownGuiFrame = u9.createElement("Frame", v32, {
    ...
    return u9.createFragment({
        ["BridgeDuelRoundCountdownScreenGui"] = u9.createElement("ScreenGui", v26, v27)
    })
end)
return {
    ["BridgeDuelRoundCountdownGui"] = v11.connect(function(_, p38) --[[ Line: 140 ]]
        local v39 = {}
