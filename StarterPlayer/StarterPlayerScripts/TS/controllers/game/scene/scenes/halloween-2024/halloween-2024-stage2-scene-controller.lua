...
local u23 = v1.import(script, script.Parent.Parent.Parent.Parent.Parent.Parent, "client-sync-events").ClientSyncEvents
local u24 = v1.import(script, script.Parent.Parent.Parent.Parent.Parent, "global", "fade", "fade-util").FadeUtil
...
local u33 = v1.import(script, script.Parent.Parent.Parent, "base-scene-controller").BaseSceneController
local u34 = v1.import(script, script.Parent.Parent.Parent, "ui", "halloween-quest-tracker").HalloweenQuestTracker
local u35 = v1.import(script, script.Parent, "environments", "halloween-stage2-environment").STAGE_2_ENVRIONMENT
...
local u37 = setmetatable({}, {
    ["__tostring"] = function() --[[ Name: __tostring, Line 47 ]]
        return "Halloween2024Stage2SceneController"
    end,
    ["__index"] = u33
})
u37.__index = u37
...
function u37.constructor(p40) --[[ Line: 57 ]]
    ...
    Upvalues:
        ...
        [3] = u12
    --]]
    u33.constructor(p40, u31.HALLOWEEN_2024_STAGE_2)
    p40.Name = "Halloween2024Stage2Scene"
...
function u37.setupSoundAmbience(p112) --[[ Line: 403 ]]
    --[[
    Upvalues:
        [1] = u19
        [2] = u6
    ...
    p112.sceneMaid:GiveTask(function() --[[ Line: 406 ]]
        --[[
        Upvalues:
            [1] = u19
            [2] = u113
    ...
    p112.sceneMaid:GiveTask(function() --[[ Line: 414 ]]
        --[[
        Upvalues:
            [1] = u114
        --]]
...
function u37.setUpDoorPrompt(p117) --[[ Line: 426 ]]
    --[[
    Upvalues:
        [1] = u16
        [2] = u10
    ...
    local u124 = 0
    u119:GetAttributeChangedSignal("CrystalCount"):Connect(function() --[[ Line: 451 ]]
        --[[
        Upvalues:
            [1] = u119
            [2] = u121
    ...
    }).Triggered:Connect(function(p131) --[[ Line: 479 ]]
        --[[
        Upvalues:
            [1] = u28
            [2] = u29
...
function u37.rockFallAnimation(u132, u133, u134) --[[ Line: 486 ]]
    --[[
    Upvalues:
        [1] = u20
        [2] = u13
    ...
    task.delay(0.3, function() --[[ Line: 501 ]]
        --[[
        Upvalues:
            [1] = u6
            [2] = u32
    ...
    task.delay(8, function() --[[ Line: 526 ]]
        --[[
        Upvalues:
            [1] = u6
            [2] = u32
        ...
        task.delay(2, function() --[[ Line: 534 ]]
            --[[
            Upvalues:
                [1] = u139
            --]]
...
function u37.rockShakeAnimation(_, u140, p141) --[[ Line: 540 ]]
    --[[
    Upvalues:
        [1] = u18
        [2] = u21
    ...
    if p141 then
        task.delay(2, function() --[[ Line: 547 ]]
            ...
            task.delay(2, function() --[[ Line: 567 ]]
                --[[
                Upvalues:
                    [1] = u149
                --]]
...
function u37.rangeAttackAnimation(_, u158, u159) --[[ Line: 611 ]]
    --[[
    Upvalues:
        [1] = u18
        [2] = u3
    ...
    if v162 and (v160 and v161) then
        ...
        u22(0.2, u11, function(p167) --[[ Line: 640 ]]
            --[[
            Upvalues:
                [1] = u166
            --]]
        ...
        task.delay(0.2, function() --[[ Line: 649 ]]
            --[[
            Upvalues:
                [1] = u166
                [2] = u159
            ...
            task.delay(1, function() --[[ Line: 668 ]]
                --[[
                Upvalues:
                    [1] = u3
                    [2] = u158
...
function u37.gateOpenCutScene(u169) --[[ Line: 675 ]]
    --[[
    Upvalues:
        [1] = u21
        [2] = u20
    ...
    task.delay(5, function() --[[ Line: 703 ]]
        --[[
        Upvalues:
            [1] = u24
            [2] = u172
        ...
        --]]
        u24:fade(0.5, 1, 0.5)
        task.delay(3, function() --[[ Line: 705 ]]
            --[[
            Upvalues:
                [1] = u172
                [2] = u173
    ...
    task.delay(2, function() --[[ Line: 709 ]]
        --[[
        Upvalues:
            [1] = u6
            [2] = u32
        ...
        if u174 then
            task.delay(1, function() --[[ Line: 714 ]]
                --[[
                Upvalues:
                    [1] = u22
                    [2] = u11
                    [3] = u174
                --]]
                u22(2, u11, function(p175) --[[ Line: 715 ]]
                    --[[
                    Upvalues:
                        [1] = u174
                    --]]
        ...
        if u176 and (u177 and (v178 and v179)) then
            u22(2, u11, function(p180) --[[ Line: 741 ]]
                --[[
                Upvalues:
                    [1] = u176
                --]]
            ...
            u22(2, u11, function(p181) --[[ Line: 744 ]]
                --[[
                Upvalues:
                    [1] = u177
                --]]
