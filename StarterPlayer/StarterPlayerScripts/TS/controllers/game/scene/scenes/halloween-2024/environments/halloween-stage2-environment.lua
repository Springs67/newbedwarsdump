local v1 = {
    ["Atmosphere"] = {
        ...
        ["Glare"] = 0.67,
        ["Offset"] = 1,
        ["Color"] = Color3.new(0.529, 0.518, 0.51),
        ["Decay"] = Color3.new(0.69, 0.69, 0.69)
    },
    ["Sky"] = {
        ["StarCount"] = 3000,
...
local v2 = {
    ...
    ["WaterWaveSize"] = 0.15,
    ["MaterialColors"] = {
        ["LeafyGrass"] = Color3.new(0.471, 0.686, 0.549),
        ["Rock"] = Color3.new(0.416, 0.416, 0.42),
        ...
        ["Cobblestone"] = Color3.new(0.494, 0.455, 0.357),
        ["Glacier"] = Color3.new(0.396, 0.69, 0.918),
        ["Ground"] = Color3.new(0.384, 0.4, 0.353),
        ...
        ["Grass"] = Color3.new(0.431, 0.616, 0.49),
...
v1.Clouds = {
    ...
    ["Enabled"] = true,
    ["Cover"] = 0.689,
    ["Color"] = Color3.new(0.459, 0.447, 0.486)
}
return {
    ["STAGE_2_ENVRIONMENT"] = v1
}