...
local u12 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "enchant", "enchant-meta").ArmorEnchantButton
local u13 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "inventory", "inventory-util").InventoryUtil
return {
    ["ArmorEnchantActionButton"] = v10.new(u9)(function(_, p14) --[[ Line: 15 ]]
        --[[
        Upvalues:
            [1] = u9
            [2] = u12
        ...
        if u5.isHoarceKat() then
            ...
            u30 = u8.Controllers.ArmorAugmentManagerController:getCannotPurchaseArmorEnchantReason(u11.LocalPlayer)
        end
        if u30 ~= "" then
            v28 = u30 or v28
        end
        local v31 = {
            ...
            ["OnClick"] = function() --[[ Name: OnClick, Line 81 ]]
                --[[
                Upvalues:
                    [1] = u29
                    [2] = u30
                ...
                task.spawn(function() --[[ Line: 64 ]]
                    ...
                    u8.Controllers.EnchantTableController:researchArmorEnchant()
                end)
            end
        }
        local v32
        if u29 and (u30 == "" or not u30) then
            v32 = v17.buttonColor
        else
            v32 = u4.darken(v17.buttonColor, 0.2)
        end
        v31.BackgroundColor3 = v32
        v31.hoverBrightness = 0.2
        v31.Selectable = true
        v31.LayoutOrder = 2
        v31.ZIndex = 10
        local v33 = {}
        ...
        v33[#v33 + 1] = u9.createElement("UIStroke", {
            ["Thickness"] = 2,
            ["Color"] = u4.brighten(v17.buttonColor, 0.1)
        })
        return u9.createElement(u3, v31, v33)
    end)
}