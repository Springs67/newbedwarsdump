...
local u6 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "enchant", "enchant-meta").ArmorEnchantMeta
local u7 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "enchant", "enchant-type").ArmorEnchantType
local u8 = v1.import(script, script.Parent, "armor-enchant-item-frame").ArmorEnchantItemFrame
return {
    ["ArmorEnchantItemGrid"] = v5.new(u4)(function(p9, p10) --[[ Line: 10 ]]
        --[[
        Upvalues:
            [1] = u3
            [2] = u7
        ...
        return u4.createFragment({
            ["ArmorEnchantsImageGrid"] = u4.createElement(u2, v18, v19)
        })
    end)
}