...
local u9 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "enchant", "enchant-meta").ToolEnchantMeta
...
return {
    ["ToolEnchantItemFrame"] = v7.new(u6)(function(p12, p13) --[[ Line: 13 ]]
        --[[
        Upvalues:
            [1] = u9
            [2] = u4
