...
local u9 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "enchant", "enchant-meta").ArmorEnchantMeta
...
return {
    ["ArmorEnchantItemFrame"] = v7.new(u6)(function(p12, p13) --[[ Line: 13 ]]
        --[[
        Upvalues:
            [1] = u9
            [2] = u4
