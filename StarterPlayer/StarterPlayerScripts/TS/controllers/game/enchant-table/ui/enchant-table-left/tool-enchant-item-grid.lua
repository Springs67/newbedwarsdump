...
local u6 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "enchant", "enchant-meta").ToolEnchantMeta
local u7 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "enchant", "enchant-type").ToolEnchantType
local u8 = v1.import(script, script.Parent, "tool-enchant-item-frame").ToolEnchantItemFrame
return {
    ["ToolEnchantItemGrid"] = v5.new(u4)(function(p9, p10) --[[ Line: 10 ]]
        --[[
        Upvalues:
            [1] = u3
            [2] = u7
        ...
        return u4.createFragment({
            ["ToolEnchantsImageGrid"] = u4.createElement(u2, v18, v19)
        })
    end)
}