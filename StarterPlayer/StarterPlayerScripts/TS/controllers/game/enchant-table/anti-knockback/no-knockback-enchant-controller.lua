...
local u5 = v1.import(script, script.Parent, "no-knockback-status-effect-handler").NoKnockbackStatusEffectHandler
...
function u6.constructor(p9) --[[ Line: 21 ]]
    ...
    --]]
    u3.constructor(p9)
    p9.Name = "NoKnockbackEnchantController"
end
function u6.KnitStart(p10) --[[ Line: 25 ]]
    ...
    --]]
    u3.KnitStart(p10)
    u2.Controllers.StatusEffectController:setHandler(u4.NO_KNOCKBACK, u5)
end
