...
function v11.render(p15) --[[ Line: 55 ]]
    ...
    local v21 = #p15.props.inputDisplay > 0
    if v21 then
        local v22 = {
            ["AnchorPoint"] = Vector2.new(0.5, 0.5),
        ...
        v21 = u5.createElement("TextLabel", v22)
    end
    if v21 then
        v18[v19 + 2] = v21
    end
...
function v11.didMount(u23) --[[ Line: 105 ]]
    --[[
    Upvalues:
        [1] = u8
        [2] = u7
    --]]
    local u24 = u8:GenerateGUID(false)
    local v25 = u7
    local v26 = "switch-camera-" .. u24
    local v27 = u23.props.inputTypes
    v25:BindAction(v26, function(_, p28, _) --[[ Line: 107 ]]
        --[[
        Upvalues:
            [1] = u23
        --]]
    ...
    end, false, unpack(v27))
    u23.maid:GiveTask(function() --[[ Line: 112 ]]
        --[[
        Upvalues:
            [1] = u7
            [2] = u24
        --]]
        u7:UnbindAction("switch-camera-" .. u24)
    end)
end
function v11.willUnmount(p29) --[[ Line: 116 ]]
    p29.maid:DoCleaning()
end
return {
