...
function u13.constructor(p16) --[[ Line: 28 ]]
    ...
    --]]
    u7.constructor(p16)
    p16.Name = "TornadoLauncherController"
end
function u13.KnitStart(p17) --[[ Line: 32 ]]
    ...
    --]]
    u7.KnitStart(p17)
    u6.ProjectileRender:connect(function(p18) --[[ Line: 34 ]]
        if p18.projectile.Name == "tornado_missile" then
            p18.cframe = p18.cframe * CFrame.Angles(0, p18.totalTime * 5 * 2 * 3.141592653589793, 0)
        end
    end)
    u6.ProjectileLaunched:connect(function(p19) --[[ Line: 41 ]]
        --[[
        Upvalues:
            [1] = u2
            [2] = u9
            ...
            [4] = u11
        --]]
        if p19:isLocalShooter() and p19.projectileType == "tornado_missile" then
            u2.resolveDependency("@easy-games/game-core:client/controllers/cooldown/cooldown-controller@CooldownController"):setOnCooldown(u9.TORNADO_LAUNCHER, u10(u11.TORNADO_LAUNCHER).projectileSource.fireDelaySec)
        end
    end)
    u6.ProjectileLaunched:connect(function(p20) --[[ Line: 46 ]]
        ...
        Upvalues:
            ...
            [2] = u12
        --]]
        if p20.projectileType == "tornado_missile" then
    ...
    u4.Controllers.PreloadController:preloadForItemType(u11.TORNADO_LAUNCHER, {
...
function u13.isRelevantItem(_, p22) --[[ Line: 62 ]]
    ...
    Upvalues:
        [1] = u11
    --]]
    return p22.itemType == u11.TORNADO_LAUNCHER
end
function u13.onEnable(p23, _, _) --[[ Line: 65 ]]
    ...
    p23:setupYield(function() --[[ Line: 66 ]]
        ...
        --]]
        local u24 = u5.new()
        u24:GiveTask(u2.resolveDependency("@easy-games/game-core:client/controllers/cooldown/cooldown-controller@CooldownController"):createCooldownBar(u9.TORNADO_LAUNCHER))
