...
function u13.constructor(p16) --[[ Line: 28 ]]
    ...
    --]]
    u7.constructor(p16)
    p16.Name = "SpringPunchController"
...
function u13.KnitStart(u17) --[[ Line: 34 ]]
    ...
    --]]
    u7.KnitStart(u17)
    u5.Controllers.PreloadController:preloadForItemType(u10.SPRING_PUNCH, {
        ["sounds"] = {
    ...
    u11.Client:Get("SpringPunchFromServer"):Connect(function(u18) --[[ Line: 43 ]]
        --[[
        Upvalues:
            [1] = u6
            [2] = u4
...
function u13.animatePunch(u25, p26, u27) --[[ Line: 82 ]]
    ...
    if p26 == u6.LocalPlayer then
        if u5.Controllers.CameraPerspectiveController:getCameraPerspective() == 0 then
            ...
            if v28 ~= nil then
                v28 = v28:FindFirstChild("spring_punch")
                if v28 ~= nil then
