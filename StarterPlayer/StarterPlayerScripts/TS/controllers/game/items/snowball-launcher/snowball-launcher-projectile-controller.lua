...
local u15 = u1.import(script, script.Parent.Parent.Parent.Parent, "global", "combat", "projectile", "projectile-source-controller").ProjectileSourceController
local u16 = u1.import(script, game:GetService("ReplicatedStorage"), "TS", "ability", "ability-id").AbilityId
local v17 = u1.import(script, game:GetService("ReplicatedStorage"), "TS", "games", "bedwars", "items", "snowball-launcher", "snowball-launcher-util")
local u18 = v17.SNOWBALL_LAUNCHER_CYCLE
local u19 = v17.SnowballLauncherMode
local u20 = v17.SnowballLauncherUtil
local u21 = u1.import(script, game:GetService("ReplicatedStorage"), "TS", "inventory", "inventory-util").InventoryUtil
...
local u24 = u1.import(script, script.Parent, "snowball-launcher-progress-bar").SnowballLauncherProgressBar
local u25 = setmetatable({}, {
    ["__tostring"] = function() --[[ Name: __tostring, Line 30 ]]
        return "SnowballLauncherProjectileController"
    end,
    ["__index"] = u15
})
u25.__index = u25
...
function u25.constructor(p28, ...) --[[ Line: 40 ]]
    ...
    --]]
    u15.constructor(p28, ...)
    p28.Name = "SnowballLauncherProjectileController"
    p28.Client = {}
...
function u25.KnitStart(u29) --[[ Line: 48 ]]
    ...
    u14.ProjectileLaunched:connect(function(p30) --[[ Line: 51 ]]
        ...
        local v33 = u20.getForce(p30.projectile, v32)
        if v33 then
        ...
        u29.snowballNum[p30.shooter] = u20.getNextNum(v32)
    end)
end
function u25.isRelevantItem(_, p35) --[[ Line: 89 ]]
    ...
    Upvalues:
        [1] = u22
    --]]
    return p35.itemType == u22.SNOWBALL_LAUNCHER
end
function u25.getProjectileSource(p36, _) --[[ Line: 92 ]]
    ...
    if p36:isDoneCharging() then
        return u20.SnowballLauncherProjectile[v37]
    else
        return u20.SnowballLauncherProjectile[u19.BASE]
    end
end
...
function u25.onStartCharging(p38) --[[ Line: 103 ]]
    ...
    Upvalues:
        ...
        [2] = u4
    --]]
    p38:setAbilityState(u16.SNOWBALL_LAUNCHER_CYCLE, u4.DISABLED)
...
function u25.onStopCharging(p39) --[[ Line: 107 ]]
    ...
    Upvalues:
        ...
        [2] = u4
    --]]
    p39:setAbilityState(u16.SNOWBALL_LAUNCHER_CYCLE, u4.READY)
...
function u25.onLaunch(p40, u41) --[[ Line: 111 ]]
    ...
    if v42 ~= u19.RAPID and v42 ~= u19.SPREAD then
        return nil
    end
    if p40:isDoneCharging() then
        ...
        local u45
        if u44 then
            local v46 = u21.getToolFromInventory(u13.LocalPlayer, u44)
            if v46 ~= nil then
                v46 = v46.amount
            end
        ...
        local u48 = u20.SnowballLauncherProjectile[v42]
        local u49 = u9.new()
        ...
        if u48.projectileType(u44) == "spread_frozen_snowball" then
            u5:playSound(u23.SNOWBALL_LAUNCHER_SPREAD_SHOT)
        elseif u48.projectileType(u44) == "rapid_frozen_snowball" then
            u5:playSound(u23.SNOWBALL_LAUNCHER_RAPID_SHOT)
        end
...
function u25.onStartReload(_) --[[ Line: 184 ]] end
function u25.getChargeTime(p56) --[[ Line: 186 ]]
    --[[
    Upvalues:
        [1] = u20
    --]]
    local v57 = p56:getCurrentMode()
    local v58 = u20.SnowballLauncherProjectile[v57].multiShotChargeTime
    return v58 == nil and 0 or v58
end
function u25.isDoneCharging(p59) --[[ Line: 194 ]]
...
function u25.onMaxCharge(p62) --[[ Line: 198 ]]
    --[[
    Upvalues:
        [1] = u5
        [2] = u23
    ...
    u5:playSound(u23.SNOWBALL_LAUNCHER_CHARGE_UP)
    local u64 = true
    p62.chargeMaid:GiveTask(function() --[[ Line: 206 ]]
        --[[
        Upvalues:
            [1] = u64
        --]]
    ...
    task.delay(v63, function() --[[ Line: 209 ]]
        --[[
        Upvalues:
            [1] = u64
            [2] = u12
    ...
    local u67 = u10.mount(u10.createElement("ScreenGui", {}, { u10.createElement(u24, {
            ["chargeTime"] = v63,
            ["title"] = u20.getTitle(p62:getCurrentMode())
        }) }), u13.LocalPlayer:WaitForChild("PlayerGui"), "ChargeSnowballLauncher")
    p62.chargeMaid:GiveTask(function() --[[ Line: 226 ]]
        --[[
        Upvalues:
            [1] = u10
            [2] = u67
...
function u25.getCurrentMode(_) --[[ Line: 230 ]]
    --[[
    Upvalues:
        [1] = u13
        [2] = u18
        [3] = u19
    --]]
    local v68 = u13.LocalPlayer:GetAttribute(u18)
    if v68 == nil then
        v68 = u19.POWER
    end
    return v68
end
function u25.setAbilityState(_, p69, p70) --[[ Line: 237 ]]
    --[[
    Upvalues:
        [1] = u2
    --]]
