...
return {
    ["ClansReducer"] = function(p3, p4) --[[ Name: ClansReducer, Line 13 ]]
        --[[
        Upvalues:
            [1] = u2
            [2] = u1
        ...
        if p4.type == "ClanUpdate" then
            ...
            return v5
        elseif p4.type == "ClanSetMyClanProfile" then
            p3.myClan = p4.myClanProfile
            return p3
        elseif p4.type == "ClanInviteIncoming" then
            p3.incomingClanInvites[p4.clanInvite.clanId] = p4.clanInvite
            return p3
        elseif p4.type == "ClanInviteDelete" then
            p3.incomingClanInvites[p4.clanId] = nil
            return p3
        elseif p4.type == "ClanSetClanPassPaid" then
            p3.hasClanPass = p4.paid
            return p3
        elseif p4.type == "ClanSetClanInvites" then
            p3.incomingClanInvites = p4.incomingClanInvites
            return p3
        elseif p4.type == "ClanSetShopData" then
            p3.clanContributionShop = {
                ["clanContributionCoins"] = p4.clanContributionCoins,
                ["weekPurchaseHistory"] = p4.weekPurchaseHistory
            }
            return p3
        elseif p4.type == "ClanSetActiveClanWar" then
            p3.activeClanWar = p4.activeClanWar
            return p3
        elseif p4.type == "ClanSetAuctions" then
            p3.auctions = p4.auctions
            return p3
        elseif p4.type == "ClanSetAuctionItems" then
            p3.auctionItems = p4.auctionItems
            return p3
        elseif p4.type == "ClanSetWinningAuctionBids" then
