...
function u4.onKill(p7, p8, p9, p10) -- Line: 30
    ...
    local u11 = u2.new();
    local v12 = ReplicatedStorage.Assets.Effects.StarParticle:Clone();
    ...
    for i, child in v12.Attachment:GetChildren() do
        local _ = i - 1;
    ...
    RuntimeLib.Promise.delay(4):andThen(function() -- Line: 53
        -- upvalues: u11 (copy)
        u11:DoCleaning();
    end);
