...
function u3.onKill(p7, p8, p9, p10) -- Line: 31
    ...
    SoundManager:playSound(GameSound.WIZARD_LIGHTNING_CAST, {
        position = p10.Position
    });
    local v14 = ReplicatedStorage.Assets.Effects.ElektraKillEffect:Clone();
    v14:PivotTo(p10);
