...
function u1.constructor(p3) -- Line: 24
    ...
    p3.Name = "KnightsBowEmoteController";
end;
...
function u1.KnitStart(p4) -- Line: 28
    ...
    local KNIGHTS_BOW = EmoteType.KNIGHTS_BOW;
    ...
    function u6.onEnable(p9, p10, p11, p12, p13) -- Line: 49
        ...
        local u14 = ReplicatedStorage.Assets.Misc.LightSword:Clone();
        u14.Parent = p11;
        ...
        p13:GiveTask(function() -- Line: 62
            -- upvalues: u14 (copy)
            u14:Destroy();
        end);
    end;

    function u6.onDisable(p16, p17, p18, p19) -- Line: 66
    end;

    EmoteHandlerController:registerHandler(KNIGHTS_BOW, u6);
end;
