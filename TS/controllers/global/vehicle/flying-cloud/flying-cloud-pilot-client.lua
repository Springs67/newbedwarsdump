...
local FLYING_CLOUD_SPEED = BalanceFile.FLYING_CLOUD_SPEED;

local function map(p8, p9, p10, p11, p12) -- Line: 29
...
function u13.constructor(u15, u16) -- Line: 46
    ...
    if CurrentCamera then
        ...
        u15.maid:GiveTask(function() -- Line: 83
    ...
    u15.maid:GiveTask(function() -- Line: 97
        -- upvalues: u17 (copy)
        u17:Destroy();
    end);
    ...
    u15.maid:GiveTask(function() -- Line: 106
        -- upvalues: u15 (copy)
    ...
    u15.maid:GiveTask(function() -- Line: 116
        -- upvalues: u15 (copy)
    ...
    u15.maid:GiveTask(RunService.Stepped:Connect(function(p18, p19) -- Line: 150
        -- upvalues: Root (copy), u6 (ref), u15 (copy), PlaceUtil (ref), FLYING_CLOUD_SPEED (ref), u16 (copy), Workspace (ref)
        ...
        local v33 = u15.holdingUp and not u15.holdingDown and 50 or (u15.holdingDown and not u15.holdingUp and -50 or 0);
        local v34;
        ...
        local v37 = u15.pitchPid:Calculate(p19, 5 * -v23.Z, (math.deg(v22)));
        ...
        local v46 = u15.rollPid:Calculate(p19, 5 * (not v43 and 0 or -1 + 2 * ((v42 - -3.141592653589793) / 6.283185307179586)), (math.deg(v21)));
        local v47 = -FLYING_CLOUD_SPEED * 0.9;
        local v48 = u15.movePid:Calculate(p19, v47 + (FLYING_CLOUD_SPEED - v47) * ((-v23.Z - -0.9) / 1.9), v27);
        local v49 = 0 + 0.5 * ((math.abs(v27) - 0) / (FLYING_CLOUD_SPEED - 0));
        ...
        u15.angularVelocity.AngularVelocity = Vector3.new(v46, v44 * 1.3, v37);
    end));
    local v55 = MountFlightControls.bindUpDownControls();
    u15.maid:GiveTask(v55.bindActionMaid);
    u15.maid:GiveTask(v55.shouldFlyUpRef.Changed:Connect(function(p56) -- Line: 246
        -- upvalues: u15 (copy)
        u15.holdingUp = p56;

        return u15.holdingUp;
    end));
    u15.maid:GiveTask(v55.shouldFlyDownRef.Changed:Connect(function(p57) -- Line: 250
        -- upvalues: u15 (copy)
        u15.holdingDown = p57;

        return u15.holdingDown;
    end));
    u15.maid:GiveTask(ClientSyncEvents.MoveMountButtonChange:connect(function(p58) -- Line: 254
...
function u13.onDisable(p60) -- Line: 283
    p60.maid:DoCleaning();
