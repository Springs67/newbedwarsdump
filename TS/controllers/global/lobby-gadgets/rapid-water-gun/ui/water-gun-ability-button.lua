...
return {
    WaterGunButton = v4.new(u3)(function(u5, p6) -- Line: 14
        -- upvalues: AbilityMeta (copy), AbilityId (copy), DeviceUtil (copy), u2 (copy), Flamework (copy), ClientSyncEvents (copy), u3 (copy), WaterGunMode (copy), Countdown (copy)
        local useState = p6.useState;
        local useEffect = p6.useEffect;
        local v7, u8 = useState(0);
        local v9, u10 = useState(false);
        local cooldown = AbilityMeta[AbilityId.WATER_GUN_SWAP].cooldown;
        ...
        local v21 = {
            ...
            AbilityButton = u3.createElement("ImageButton", {
                ...
                AbilityIcon = u3.createElement("ImageLabel", {
                    ...
                    Position = UDim2.fromScale(0.5, 0.5),
                    AnchorPoint = Vector2.new(0.5, 0.5),
                    Image = u5.buttonMode == WaterGunMode.RAPID and "rbxassetid://11611911951" or "rbxassetid://139613766654382",
