...
local FrostyGunButton = RuntimeLib.import(script, script.Parent, "frosty-gun-ability-button").FrostyGunButton;

return {
    FrostyGunCore = v3.new(u2)(function(u4, p5) -- Line: 11
        -- upvalues: DeviceUtil (copy), Flamework (copy), u2 (copy), UIUtil (copy), FrostyGunButton (copy), BedwarsImageId (copy)
        local _ = p5.useState;
        ...
        local function _(p25, p26) -- Line: 111
            -- upvalues: u2 (ref), FrostyGunButton (ref), u4 (copy)
            return u2.createElement(FrostyGunButton, {
                extra = false,
        ...
        for i, v in Modes do
            local _ = i - 1;
            v27[i] = u2.createElement(FrostyGunButton, {
                extra = false,
                ChangeAbility = u4.ChangeAbility,
                activeMode = u4.activeMode,
                buttonMode = v
        ...
        return u2.createFragment({
            FrostGunAbilityBar = u2.createElement("Frame", v18, v21)
        });
    end)
};