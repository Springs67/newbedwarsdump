...
local InventoryApp = RuntimeLib.import(script, script.Parent, "inventory-app").InventoryApp;
...
return function(p6) -- Line: 33
    -- upvalues: CreateRoduxApp (copy), InventoryApp (copy), HotbarApp (copy), ClientStore (copy), createItem (copy), ItemType (copy), u2 (copy)
    local u7 = CreateRoduxApp("Inventory", InventoryApp, {}, {}, {
        Parent = p6
    });
