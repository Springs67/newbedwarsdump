...
return {
    HalloweenAbilityTreeChoiceArea = v3.new(u2)(function(p4, p5) -- Line: 10
        -- upvalues: u2 (copy), SlideIn (copy), BedwarsImageId (copy), ColorUtil (copy), HalloweenAbilityTreeChoices (copy)
        local _ = p5.useState;

        return u2.createElement(SlideIn, {}, {
            HalloweenChoiceArea = u2.createElement("Frame", {
