...
function u1.constructor(p3) -- Line: 21
    ...
    PvPArenaBaseAugmentController.constructor(p3, PvPArenaAugmentType.MINER);
    p3.Name = "PvPArenaMinerAugmentController";
end;

function u1.onActivated(p4) -- Line: 25
    -- upvalues: KnitClient (copy), Players (copy)
    KnitClient.Controllers.MinerController:add(Players.LocalPlayer);
    KnitClient.Controllers.MinerController:initKit(Players.LocalPlayer);
    KnitClient.Controllers.MinerController:setupMinerPrompts(1);
end;
