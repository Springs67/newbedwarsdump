...
local u1 = setmetatable({}, {
    __tostring = function() -- Line: 11, Name: __tostring
        return "PvPArenaSeahorseAugmentController";
    end,
...
function u1.constructor(p3) -- Line: 21
    ...
    PvPArenaBaseAugmentController.constructor(p3, PvPArenaAugmentType.SEAHORSE);
    p3.Name = "PvPArenaSeahorseAugmentController";
end;

function u1.onActivated(p4) -- Line: 25
    -- upvalues: KnitClient (copy), Players (copy)
    KnitClient.Controllers.SeahorseController:add(Players.LocalPlayer);
    KnitClient.Controllers.SeahorseController:initKit(Players.LocalPlayer);
end;
