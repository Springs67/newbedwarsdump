...
return {
    SkeletonKitReviveBarGUI = v3.new(u2)(function(u5, p6) -- Line: 11
        ...
        useEffect(function() -- Line: 15
            ...
            local u10 = RunService.Heartbeat:Connect(function() -- Line: 16
        ...
        return u2.createFragment({
            SkeletonKitReviveBar = u2.createElement("BillboardGui", {
