...
return {
    SwapButton = v4.new(u3)(function(u5, p6) -- Line: 15
        -- upvalues: AbilityMeta (copy), AbilityId (copy), DeviceUtil (copy), u2 (copy), Flamework (copy), ClientSyncEvents (copy), u3 (copy), NecromancerSummonType (copy), BedwarsImageId (copy), Countdown (copy)
        local useState = p6.useState;
        local useEffect = p6.useEffect;
        local v7, u8 = useState(0);
        local v9, u10 = useState(false);
        local cooldown = AbilityMeta[AbilityId.NECROMANCER_SWAP].cooldown;
        ...
        useEffect(function() -- Line: 27
            ...
            u13:GiveTask(ClientSyncEvents.CooldownStarted:connect(function(p15) -- Line: 41
            ...
            u13:GiveTask(ClientSyncEvents.CooldownExpired:connect(function(p17) -- Line: 55
        ...
        local v19 = { (u3.createElement("UIAspectRatioConstraint", {
                AspectRatio = 0.8
            })) };
        ...
        local v22 = {
            ...
            [u3.Event.Activated] = function(p20, p21) -- Line: 83
                -- upvalues: u5 (copy)
                u5.ChangeAbility(u5.buttonMode);
            end
        };
        local v23 = { u3.createElement("UIAspectRatioConstraint", {
                AspectRatio = 1
        ...
        if u5.buttonMode == NecromancerSummonType.MELEE then
            v25 = BedwarsImageId.SWORD_ICON;
        else
            v25 = BedwarsImageId.BOW_ARROW_ICON_SOLID;
        end;

        v24.Image = v25;
        v24.ImageColor3 = Color3.fromHex("C0E8FF");
        v24.ImageTransparency = v11 and not v9 and 0 or 0.5;
        v23.AbilityIcon = createElement2("ImageLabel", v24, { u3.createElement("UIAspectRatioConstraint", {
                AspectRatio = 1
            }) });
        v19.AbilityButton = createElement("ImageButton", v22, v23);
        local v26 = #v19;
        ...
        v19.ManaRequirementWrapper = u3.createElement("Frame", v27, v28);

        return u3.createFragment({
            AbilityButtonContainer = u3.createElement("Frame", v18, v19)
        });
    end)
};