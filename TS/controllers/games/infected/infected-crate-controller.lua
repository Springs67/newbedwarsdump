...
function u2.constructor(p4) -- Line: 25
    ...
    p4.Name = "InfectedCrateController";
end;

function u2.KnitStart(p5) -- Line: 29
    -- upvalues: KnitController (copy), default (copy), SoundManager (copy), GameSound (copy), KnitClient (copy), WatchCollectionTag (copy), BlockEngine (copy)
    KnitController.KnitStart(p5);
    default.Client:Get("CrateOpened"):Connect(function(p6) -- Line: 31
    ...
    WatchCollectionTag("infected-crate", function(p9) -- Line: 54
