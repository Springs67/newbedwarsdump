...
local JuggHud = RuntimeLib.import(script, script.Parent, "jugg-hud").JuggHud;

return function(p3) -- Line: 9
    -- upvalues: u2 (copy), GameReducer (copy), BedwarsReducer (copy), u1 (copy), StoreProvider (copy), JuggHud (copy)
