...
return {
    ArmorEnchantItemFrame = v3.new(u2)(function(p4, p5) -- Line: 13
        -- upvalues: ArmorEnchantMeta (copy), ColorUtil (copy), u2 (copy), BedwarsImageId (copy), TweenService (copy), Theme (copy), TooltipContainer (copy), AutoSizedText (copy)
        local _ = p5.useState;
        local u6 = ArmorEnchantMeta[p4.ArmorEnchant];
