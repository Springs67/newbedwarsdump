...
function u2.KnitStart(u5) -- Line: 34
    ...
    KnitClient.Controllers.PreloadController:preloadForItemType(ItemType.SPRING_PUNCH, {
        sounds = {
    ...
    default.Client:Get("SpringPunchFromServer"):Connect(function(u6) -- Line: 43
...
function u2.animatePunch(u9, p10, u11) -- Line: 82
    ...
    if p10 == Players.LocalPlayer then
        if KnitClient.Controllers.CameraPerspectiveController:getCameraPerspective() == 0 then
            ...
            if v12 ~= nil then
                v12 = v12:FindFirstChild("spring_punch");
    ...
    if v15 then
        task.delay(0.2, function() -- Line: 190
