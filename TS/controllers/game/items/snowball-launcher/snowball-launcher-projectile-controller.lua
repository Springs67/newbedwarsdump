...
function u7.constructor(p9, ...) -- Line: 40
    ...
    p9.Name = "SnowballLauncherProjectileController";
    p9.Client = {};
...
function u7.onLaunch(p24, u25) -- Line: 111
    -- upvalues: SnowballLauncherMode (copy), InventoryUtil (copy), Players (copy), SnowballLauncherUtil (copy), u3 (copy), KnitClient (copy), SoundManager (copy), GameSound (copy), RuntimeLib (copy), KnitClient2 (copy)
...
function u7.onStartReload(p37) -- Line: 184
end;

function u7.getChargeTime(p38) -- Line: 186
    -- upvalues: SnowballLauncherUtil (copy)
...
function u7.isDoneCharging(p40) -- Line: 194
...
function u7.onMaxCharge(p43) -- Line: 198
    ...
    local u45 = true;
    p43.chargeMaid:GiveTask(function() -- Line: 206
        -- upvalues: u45 (ref)
        u45 = false;
    end);
    task.delay(v44, function() -- Line: 209
        -- upvalues: u45 (ref), CollectionService (ref)
        if u45 then
            local function _(p46) -- Line: 212
    ...
    p43.chargeMaid:GiveTask(function() -- Line: 226
        -- upvalues: u4 (ref), u47 (copy)
        u4.unmount(u47);
    end);
end;

function u7.getCurrentMode(p48) -- Line: 230
...
function u7.setAbilityState(p50, p51, p52) -- Line: 237
