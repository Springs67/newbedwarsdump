...
return {
    MagicalGirlScepterProgressBar = v2.new(u1)(function(u3, p4) -- Line: 7
        ...
        useEffect(function() -- Line: 13
            -- upvalues: TweenService (ref), u5 (copy), u6 (copy), u3 (copy), u7 (copy)
            ...
            if u3.noBar then
                TweenService:Create(u7:getValue(), TweenInfo.new(u3.chargeTime, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
                    TextTransparency = 1
                }):Play();
            end;
        end, {});
        ...
        return u1.createFragment({ u1.createElement("Frame", {
                ...
                BackgroundTransparency = u3.noBar and 1 or 0.7,
                BorderSizePixel = 0
                    ...
                    BorderSizePixel = 0,
                    BackgroundTransparency = u3.noBar and 1 or 0
