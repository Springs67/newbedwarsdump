...
local v4 = u3.Component:extend("BallistaExit");
...
function v4.didMount(u11) -- Line: 80
    ...
    ContextActionService:BindAction("ballista-exit", function(p12, p13, p14) -- Line: 81
        -- upvalues: u11 (copy)
    ...
    u11.maid:GiveTask(function() -- Line: 86
        ...
        ContextActionService:UnbindAction("ballista-exit");
    end);
end;
