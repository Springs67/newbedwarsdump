...
local STAGE_2_ENVRIONMENT = RuntimeLib.import(script, script.Parent, "environments", "halloween-stage2-environment").STAGE_2_ENVRIONMENT;
...
function u8.constructor(p10) -- Line: 57
    ...
    BaseSceneController.constructor(p10, SceneKey.HALLOWEEN_2024_STAGE_2);
    p10.Name = "Halloween2024Stage2Scene";
...
function u8.setupSoundAmbience(p51) -- Line: 403
    ...
    p51.sceneMaid:GiveTask(function() -- Line: 406
    ...
    p51.sceneMaid:GiveTask(function() -- Line: 414
        -- upvalues: u52 (copy)
        u52:Stop();
        u52:Destroy();
    end);
...
function u8.setUpDoorPrompt(p53) -- Line: 426
    ...
    local u59 = 0;
    u55:GetAttributeChangedSignal("CrystalCount"):Connect(function() -- Line: 451
    ...
    }).Triggered:Connect(function(p64) -- Line: 479
...
function u8.rockFallAnimation(u65, u66, u67) -- Line: 486
...
function u8.rockShakeAnimation(p70, u71, p72) -- Line: 540
...
function u8.rangeAttackAnimation(p82, u83, u84) -- Line: 611
    ...
    if spider_web_lasso and (PrimaryPart and PrimaryPart2) then
        ...
        default(0.2, InQuad, function(p88) -- Line: 640
            -- upvalues: u87 (copy)
            u87:PivotTo(p88);
...
function u8.gateOpenCutScene(u89) -- Line: 675
    ...
    task.delay(2, function() -- Line: 709
        ...
        if u90 then
            task.delay(1, function() -- Line: 714
                ...
                default(2, InQuad, function(p91) -- Line: 715
                    -- upvalues: u90 (ref)
                    u90.Volume = p91;
                end, u90.Volume, 0);
            end);
        ...
        if door3 and (door4 and (door5 and door6)) then
            default(2, InQuad, function(p92) -- Line: 741
                -- upvalues: door3 (copy)
                door3:PivotTo(p92);
            end, door3.CFrame, door5.CFrame);
            default(2, InQuad, function(p93) -- Line: 744
                -- upvalues: door4 (copy)
                door4:PivotTo(p93);
