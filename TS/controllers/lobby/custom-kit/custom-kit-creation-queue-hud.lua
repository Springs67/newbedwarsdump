...
return {
    CustomKitCreationQueueHud = v3.new(u2)(function(p4, p5) -- Line: 12
        -- upvalues: u2 (copy), TweenService (copy), DeviceUtil (copy), ColorUtil (copy), Button (copy), Empty (copy), CircularSpinner (copy)
        local _ = p5.useState;
        ...
        return u2.createFragment({
            CustomKitCreationQueueHud = u2.createElement("ScreenGui", {
                DisplayOrder = 1000
                        ...
                        LeftSection = u2.createElement(Empty, {
                            ...
                            Size = UDim2.fromScale(0.7, 1)
                                ...
                                Size = UDim2.fromScale(0.8, 0.8)
                                    ...
                                    BorderSizePixel = 0,
                                    TextXAlignment = "Left",
                                    Text = message == nil and "Entering Custom Kit Creation" or message,
