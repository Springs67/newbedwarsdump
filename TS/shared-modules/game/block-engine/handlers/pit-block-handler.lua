...
function u4.getPlacementPositions(_, p8, _) --[[ Line: 23 ]]
    return {
        p8 + Vector3.new(0, 0, 0),
        p8 + Vector3.new(1, 0, 0),
        p8 + Vector3.new(-1, 0, 0),
        p8 + Vector3.new(0, 0, 1),
        p8 + Vector3.new(0, 0, -1),
        p8 + Vector3.new(1, 0, 1),
        p8 + Vector3.new(-1, 0, -1),
        p8 + Vector3.new(-1, 0, 1),
        p8 + Vector3.new(1, 0, -1)
    }
end
function u4.getContainedPositions(_, p9) --[[ Line: 53 ]]
    --[[
    Upvalues:
        [1] = u2
    --]]
    ...
    return {
        ...
        v10 + Vector3.new(1, 0, 0),
        v10 + Vector3.new(-1, 0, 0),
        v10 + Vector3.new(0, 0, 1),
        v10 + Vector3.new(0, 0, -1),
        v10 + Vector3.new(1, 0, 1),
        v10 + Vector3.new(-1, 0, -1),
        v10 + Vector3.new(-1, 0, 1),
        v10 + Vector3.new(1, 0, -1)
    }
