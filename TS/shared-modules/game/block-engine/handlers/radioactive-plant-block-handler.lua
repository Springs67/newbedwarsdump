...
local u4 = setmetatable({}, {
    ["__tostring"] = function() --[[ Name: __tostring, Line 10 ]]
        return "RadioactivePlantBlockHandler"
    end,
    ["__index"] = u3
})
u4.__index = u4
...
function u4.getPlacementPositions(_, p8, _) --[[ Line: 23 ]]
    return { p8, p8 + Vector3.new(0, 1, 0) }
end
function u4.getContainedPositions(_, p9) --[[ Line: 29 ]]
    --[[
    Upvalues:
        [1] = u2
    --]]
    local v10 = u2:getBlockPosition(p9.Position)
    return { v10, v10 + Vector3.new(0, 1, 0) }
end
return {
    ["RadioactivePlantBlockHandler"] = u4
}