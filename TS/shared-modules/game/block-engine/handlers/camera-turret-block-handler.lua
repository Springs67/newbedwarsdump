...
function u9.createNewInstance(p15, p16) --[[ Line: 44 ]]
    --[[
    Upvalues:
        [1] = u8
        [2] = u4
...
function u9.getPlacementPositions(_, p19, _) --[[ Line: 56 ]]
    return { p19, p19 + Vector3.new(0, 1, 0) }
end
function u9.getContainedPositions(_, p20) --[[ Line: 62 ]]
    --[[
    Upvalues:
        [1] = u3
    --]]
    local v21 = u3:getBlockPosition(p20.Position)
    return { v21, v21 + Vector3.new(0, 1, 0) }
end
return {
    ["CameraTurretBlockHandler"] = u9
}