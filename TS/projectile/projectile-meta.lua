...
local v2 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "balance", "magical-girl-rapier-balance").MagicalGirlRapierBalance
local v3 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "balance", "owl-balance-file").OwlBalance
local v4 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "balance", "sorcerer-balance")
local v5 = v4.SorcererBalance
local v6 = v4.SorcererTier
local u7 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "damage", "damage-type").DamageType
local v8 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "explosion", "explosion-type").ExplosionType
local v9 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "games", "bedwars", "kit", "kits", "block-kicker", "block-kicker-kit-balance").BlockKickerKitBalance
local v10 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "games", "bedwars", "kit", "kits", "frosty-gun", "frosty-gun-util").FrostyStaffUtil
local v11 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "games", "bedwars", "kit", "kits", "nazar", "nazar-kit-balance").NazarKitBalance
local v12 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "games", "bedwars", "kit", "kits", "ninja", "ninja-kit-balance").NinjaKitBalance
local v13 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "games", "bedwars", "kit", "kits", "vulcan", "vulcan-util").VulcanUtil
local u14 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "games", "custom-kit-game", "custom-kit-util").CustomKitUtil
local v15 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "games", "halloween-2024-event", "halloween-balance-config").HalloweenBalanceConfig
local v16 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "item", "item-type").ItemType
local u17 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "items", "lasso", "lasso-util").LassoUtil
local v18 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "sound", "game-sound").GameSound
local v19 = v1.import(script, game:GetService("ReplicatedStorage"), "TS", "projectile", "projectile-skin-type").ProjectileSkin
local u21 = {
    ["arrow"] = {
        ["launchVelocity"] = 240,
    ...
    ["lasso"] = {
        ...
        ["getProjectileOverridesFunction"] = function(p20) --[[ Name: getProjectileOverridesFunction, Line 291 ]]
            --[[
            Upvalues:
                [1] = u17
            --]]
            return u17.getProjectileOverrides(p20)
        end
    },
    ["lightning_strike"] = {
        ["launchVelocity"] = 120,
...
local v22 = {
    ...
    ["lifetimeSec"] = 1.5,
    ["launchVelocity"] = v13.TURRET_BULLET_SPEED,
    ["combat"] = {
        ["noApplyDamageCooldown"] = true,
        ["ignoreDamageTakenCooldown"] = true,
        ["damage"] = v13.TURRET_REMOTE_CONTROL_BULLET_DAMAGE,
        ["armorMultiplier"] = v13.TURRET_BULLET_ARMOR_MULTIPLIER
    },
    ["knockbackMultiplier"] = {
        ["horizontal"] = 0.4
    }
}
u21.turretBullet = v22
local v23 = {
    ["gravitationalAcceleration"] = 10,
    ["predictionLifetimeSec"] = 1.5,
    ["lifetimeSec"] = 1.5,
    ...
    ["combat"] = {
        ["noApplyDamageCooldown"] = true,
        ["ignoreDamageTakenCooldown"] = true,
        ["damage"] = v13.TURRET_ARTILLERY_BULLET_DAMAGE,
        ["armorMultiplier"] = v13.TURRET_BULLET_ARMOR_MULTIPLIER
    },
    ["knockbackMultiplier"] = {
        ["horizontal"] = 0.4
...
u21.block_kicker_block = {
    ["lifetimeSec"] = 8,
    ["launchVelocity"] = v9.KICK_BLOCK_VELOCITY,
    ["gravitationalAcceleration"] = v9.KICK_BLOCK_GRAVITATIONAL_ACCELERATION
}
u21.frozen_fortress = {
    ["launchVelocity"] = 120,
    ["gravitationalAcceleration"] = 120,
...
u21.ninja_chakram_1 = {
    ...
    ["spinSpeed"] = 20,
    ["launchVelocity"] = v12.CHAKRAM_VELOCITY_MAX,
    ["predictionLifetimeSec"] = v12.CHAKRAM_RANGE_1 / v12.CHAKRAM_VELOCITY_MAX,
    ["returnDistance"] = v12.CHAKRAM_RANGE_1
}
u21.ninja_chakram_2 = {
    ["gravitationalAcceleration"] = 0,
    ["lifetimeSec"] = 20,
    ...
    ["spinSpeed"] = 20,
    ["launchVelocity"] = v12.CHAKRAM_VELOCITY_MAX,
    ["predictionLifetimeSec"] = v12.CHAKRAM_RANGE_2 / v12.CHAKRAM_VELOCITY_MAX,
    ["returnDistance"] = v12.CHAKRAM_RANGE_2
}
u21.ninja_chakram_3 = {
    ["gravitationalAcceleration"] = 0,
    ["lifetimeSec"] = 20,
    ...
    ["spinSpeed"] = 20,
    ["launchVelocity"] = v12.CHAKRAM_VELOCITY_MAX,
    ["predictionLifetimeSec"] = v12.CHAKRAM_RANGE_3 / v12.CHAKRAM_VELOCITY_MAX,
    ["returnDistance"] = v12.CHAKRAM_RANGE_3
}
u21.ninja_chakram_4 = {
    ["gravitationalAcceleration"] = 0,
    ["lifetimeSec"] = 20,
    ...
    ["spinSpeed"] = 20,
    ["launchVelocity"] = v12.CHAKRAM_VELOCITY_MAX,
    ["predictionLifetimeSec"] = v12.CHAKRAM_RANGE_4 / v12.CHAKRAM_VELOCITY_MAX,
    ["returnDistance"] = v12.CHAKRAM_RANGE_4
}
u21.bananarang = {
    ["gravitationalAcceleration"] = 0,
    ["launchVelocity"] = 140,
...
local v42 = {
    ...
    ["arrow"] = true,
    ["combat"] = {
        ["damage"] = v11.LIFE_CROSSBOW_DAMAGE,
        ["damageType"] = u7.LIFE_ARROW,
...
local v43 = {
    ...
    ["arrow"] = true,
    ["combat"] = {
        ["damage"] = v11.LIFE_HEADHUNTER_DAMAGE,
        ["damageType"] = u7.LIFE_ARROW,
...
local v44 = {
    ...
    ["spinAxis"] = Vector3.new(-1, 0, 0),
    ["spinSpeed"] = 1.2,
    ["lifetimeSec"] = v5.getSorcererTierData(v6.TIER_1).projectileLifetime,
    ["combat"] = {
        ["noApplyDamageCooldown"] = true,
        ["ignoreDamageTakenCooldown"] = true,
        ["damage"] = v5.getSorcererTierData(v6.TIER_1).projectileOnHitDamage
    },
    ["knockbackMultiplier"] = {
        ["horizontal"] = 0.3,
        ["vertical"] = 0.1
    ...
    ["explosive"] = {
        ...
        ["explosionType"] = v8.SORCERER_EXPLOSION_1
    }
}
u21.sorcerer_projectile_1 = v44
local v45 = {
    ["launchVelocity"] = 1000,
    ["gravitationalAcceleration"] = 0,
    ["predictionLifetimeSec"] = 1,
    ...
    ["spinAxis"] = Vector3.new(-1, 0, 0),
    ["spinSpeed"] = 1.2,
    ["lifetimeSec"] = v5.getSorcererTierData(v6.TIER_2).projectileLifetime,
    ["combat"] = {
        ["noApplyDamageCooldown"] = true,
        ["ignoreDamageTakenCooldown"] = true,
        ["damage"] = v5.getSorcererTierData(v6.TIER_2).projectileOnHitDamage
    },
    ["knockbackMultiplier"] = {
        ["horizontal"] = 0.5,
        ["vertical"] = 0.2
    ...
    ["explosive"] = {
        ...
        ["destroyMapBlocks"] = false,
        ["removeDefaultExplosionEffect"] = true,
        ["explosionType"] = v8.SORCERER_EXPLOSION_2
    }
}
u21.sorcerer_projectile_2 = v45
local v46 = {
    ["launchVelocity"] = 1000,
    ["gravitationalAcceleration"] = 0,
    ["predictionLifetimeSec"] = 1,
    ...
    ["spinAxis"] = Vector3.new(-1, 0, 0),
    ["spinSpeed"] = 1.2,
    ["lifetimeSec"] = v5.getSorcererTierData(v6.TIER_3).projectileLifetime,
    ["combat"] = {
        ["noApplyDamageCooldown"] = true,
        ["ignoreDamageTakenCooldown"] = true,
        ["damage"] = v5.getSorcererTierData(v6.TIER_3).projectileOnHitDamage
    },
    ["knockbackMultiplier"] = {
        ["horizontal"] = 0.8,
        ["vertical"] = 0.3
    ...
    ["explosive"] = {
        ...
        ["destroyMapBlocks"] = false,
        ["removeDefaultExplosionEffect"] = true,
        ["explosionType"] = v8.SORCERER_EXPLOSION_3
    }
}
u21.sorcerer_projectile_3 = v46
local v47 = {
    ["launchVelocity"] = 1000,
    ["gravitationalAcceleration"] = 0,
    ["predictionLifetimeSec"] = 1,
    ...
    ["spinAxis"] = Vector3.new(-1, 0, 0),
    ["spinSpeed"] = 1.2,
    ["lifetimeSec"] = v5.getSorcererTierData(v6.TIER_4).projectileLifetime,
    ["combat"] = {
        ["noApplyDamageCooldown"] = true,
        ["ignoreDamageTakenCooldown"] = true,
        ["damage"] = v5.getSorcererTierData(v6.TIER_4).projectileOnHitDamage
    },
    ["knockbackMultiplier"] = {
        ["horizontal"] = 0.8,
        ["vertical"] = 0.3
...
local v48 = {
    ...
    ["spinAxis"] = Vector3.new(-1, 0, 0),
    ["spinSpeed"] = 1.2,
    ["lifetimeSec"] = v5.getSorcererTierData(v6.TIER_5).projectileLifetime,
    ["combat"] = {
        ["noApplyDamageCooldown"] = true,
        ["ignoreDamageTakenCooldown"] = true,
        ["damage"] = v5.getSorcererTierData(v6.TIER_5).projectileOnHitDamage
    },
    ["knockbackMultiplier"] = {
        ["horizontal"] = 0.8,
        ["vertical"] = 0.3
...
local v49 = {
    ...
    ["bypassShooterLock"] = true,
    ["flightRotation"] = Vector3.new(0, -1.5707964, 0),
    ["projectileModel"] = "sorcerer_projectile_1_halloween",
    ["spinAxis"] = Vector3.new(-1, 0, 0),
    ["spinSpeed"] = 1.2,
    ["lifetimeSec"] = v5.getSorcererTierData(v6.TIER_1).projectileLifetime,
    ["combat"] = {
        ["noApplyDamageCooldown"] = true,
        ["ignoreDamageTakenCooldown"] = true,
        ["damage"] = v15.PROJECTILE_ON_HIT_DMG_TIER_1_HALLOWEEN,
        ["damageType"] = u7.DEATH_ADDER_HALLOWEEN
    },
    ["knockbackMultiplier"] = {
        ["horizontal"] = 0.3,
        ["vertical"] = 0.1
...
u21.sorcerer_projectile_1_halloween = v49
local v50 = {
    ["launchVelocity"] = 1000,
    ["gravitationalAcceleration"] = 0,
    ["predictionLifetimeSec"] = 1,
    ...
    ["bypassShooterLock"] = true,
    ["flightRotation"] = Vector3.new(0, -1.5707964, 0),
    ["projectileModel"] = "sorcerer_projectile_2_halloween",
    ["spinAxis"] = Vector3.new(-1, 0, 0),
    ["spinSpeed"] = 1.2,
    ["lifetimeSec"] = v5.getSorcererTierData(v6.TIER_2).projectileLifetime,
    ["combat"] = {
        ["noApplyDamageCooldown"] = true,
        ["ignoreDamageTakenCooldown"] = true,
        ["damage"] = v15.PROJECTILE_ON_HIT_DMG_TIER_2_HALLOWEEN,
        ["damageType"] = u7.DEATH_ADDER_HALLOWEEN
    },
    ["knockbackMultiplier"] = {
        ["horizontal"] = 0.5,
...
u21.sorcerer_projectile_2_halloween = v50
local v51 = {
    ["launchVelocity"] = 1000,
    ["gravitationalAcceleration"] = 0,
    ["predictionLifetimeSec"] = 1,
    ...
    ["bypassShooterLock"] = true,
    ["flightRotation"] = Vector3.new(0, -1.5707964, 0),
    ["projectileModel"] = "sorcerer_projectile_3_halloween",
    ["spinAxis"] = Vector3.new(-1, 0, 0),
    ["spinSpeed"] = 1.2,
    ["lifetimeSec"] = v5.getSorcererTierData(v6.TIER_3).projectileLifetime,
    ["combat"] = {
        ["noApplyDamageCooldown"] = true,
        ["ignoreDamageTakenCooldown"] = true,
        ["damage"] = v15.PROJECTILE_ON_HIT_DMG_TIER_3_HALLOWEEN,
        ["damageType"] = u7.DEATH_ADDER_HALLOWEEN
    },
    ["knockbackMultiplier"] = {
        ["horizontal"] = 0.8,
...
u21.sorcerer_projectile_3_halloween = v51
local v52 = {
    ["launchVelocity"] = 1000,
    ["gravitationalAcceleration"] = 0,
    ["predictionLifetimeSec"] = 1,
    ...
    ["bypassShooterLock"] = true,
    ["flightRotation"] = Vector3.new(0, -1.5707964, 0),
    ["projectileModel"] = "sorcerer_projectile_1_halloween_huge",
    ["spinAxis"] = Vector3.new(-1, 0, 0),
    ["spinSpeed"] = 1.2,
    ["lifetimeSec"] = v5.getSorcererTierData(v6.TIER_1).projectileLifetime,
    ["combat"] = {
        ["noApplyDamageCooldown"] = true,
        ["ignoreDamageTakenCooldown"] = true,
        ["damage"] = v15.PROJECTILE_ON_HIT_DMG_TIER_1_HALLOWEEN + v15.PROJECTILE_ON_HIT_DMG_TIER_1_HALLOWEEN * v15.DEATH_ADDER_HUGE_SHOT_DAMAGE_PERCENT / 100,
        ["damageType"] = u7.DEATH_ADDER_HALLOWEEN
    },
    ["knockbackMultiplier"] = {
        ["horizontal"] = 0.3,
    ...
    ["explosive"] = {
        ...
        ["destroyMapBlocks"] = false,
        ["removeDefaultExplosionEffect"] = true,
        ["explosionType"] = v8.SORCERER_EXPLOSION_1_HUGE
    }
}
u21.sorcerer_projectile_1_halloween_huge = v52
local v53 = {
    ["launchVelocity"] = 1000,
    ["gravitationalAcceleration"] = 0,
    ["predictionLifetimeSec"] = 1,
    ...
    ["bypassShooterLock"] = true,
    ["flightRotation"] = Vector3.new(0, -1.5707964, 0),
    ["projectileModel"] = "sorcerer_projectile_2_halloween_huge",
    ["spinAxis"] = Vector3.new(-1, 0, 0),
    ["spinSpeed"] = 1.2,
    ["lifetimeSec"] = v5.getSorcererTierData(v6.TIER_2).projectileLifetime,
    ["combat"] = {
        ["noApplyDamageCooldown"] = true,
        ["ignoreDamageTakenCooldown"] = true,
        ["damage"] = v15.PROJECTILE_ON_HIT_DMG_TIER_2_HALLOWEEN + v15.PROJECTILE_ON_HIT_DMG_TIER_2_HALLOWEEN * v15.DEATH_ADDER_HUGE_SHOT_DAMAGE_PERCENT / 100,
        ["damageType"] = u7.DEATH_ADDER_HALLOWEEN
    },
    ["knockbackMultiplier"] = {
        ["horizontal"] = 0.5,
    ...
    ["explosive"] = {
        ...
        ["destroyMapBlocks"] = false,
        ["removeDefaultExplosionEffect"] = true,
        ["explosionType"] = v8.SORCERER_EXPLOSION_2_HUGE
    }
}
u21.sorcerer_projectile_2_halloween_huge = v53
local v54 = {
    ["launchVelocity"] = 1000,
    ["gravitationalAcceleration"] = 0,
    ["predictionLifetimeSec"] = 1,
    ...
    ["bypassShooterLock"] = true,
    ["flightRotation"] = Vector3.new(0, -1.5707964, 0),
    ["projectileModel"] = "sorcerer_projectile_3_halloween_huge",
    ["spinAxis"] = Vector3.new(-1, 0, 0),
    ["spinSpeed"] = 1.2,
    ["lifetimeSec"] = v5.getSorcererTierData(v6.TIER_3).projectileLifetime,
    ["combat"] = {
        ["noApplyDamageCooldown"] = true,
        ["ignoreDamageTakenCooldown"] = true,
        ["damage"] = v15.PROJECTILE_ON_HIT_DMG_TIER_3_HALLOWEEN + v15.PROJECTILE_ON_HIT_DMG_TIER_3_HALLOWEEN * v15.DEATH_ADDER_HUGE_SHOT_DAMAGE_PERCENT / 100,
        ["damageType"] = u7.DEATH_ADDER_HALLOWEEN
    },
    ["knockbackMultiplier"] = {
        ["horizontal"] = 0.8,
    ...
    ["explosive"] = {
        ...
        ["destroyMapBlocks"] = false,
        ["removeDefaultExplosionEffect"] = true,
        ["explosionType"] = v8.SORCERER_EXPLOSION_3_HUGE
    }
}
u21.sorcerer_projectile_3_halloween_huge = v54
u21.pit = {
    ["launchVelocity"] = 100,
    ["gravitationalAcceleration"] = 85,
    ["lifetimeSec"] = 3,
...
u21.attack_spirit = {
    ...
    ["skins"] = { v19.UMA_EASTER_ATTACK_SPIRIT }
}
u21.heal_spirit = {
    ["launchVelocity"] = 100,
    ["gravitationalAcceleration"] = 80,
    ...
    ["skins"] = { v19.UMA_EASTER_HEAL_SPIRIT }
}
u21.watermelon_seed = {
    ["launchVelocity"] = 330,
    ["flightRotation"] = Vector3.new(1.5707964, 0, 0),
...
u21.custom_kit_projectile = {
    ...
    ["getProjectileOverridesFunction"] = function(p55) --[[ Name: getProjectileOverridesFunction, Line 2286 ]]
        --[[
        Upvalues:
            [1] = u14
        --]]
        return u14.getProjectileOverrides(p55)
    end
}
local v56 = {
    ["launchVelocity"] = 280,
