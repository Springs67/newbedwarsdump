...
function u6.shouldApply(p10, p11) --[[ Line: 26 ]]
    ...
    Upvalues:
        [1] = u3
    --]]
    local v12 = u3(p11, p10.config.kit)
    if v12 then
...
function u6.getOverride(_) --[[ Line: 42 ]]
    ...
    return {
        {
            ["price"] = 40,
            ["itemType"] = u2.STONE_SWORD
        },
        {
            ["price"] = 40,
            ["itemType"] = u2.STONE_DAGGER
        },
        {
            ["price"] = 40,
            ["itemType"] = u2.STONE_SCYTHE
        },
        {
            ["price"] = 40,
            ["itemType"] = u2.STONE_GREAT_HAMMER
        },
        {
            ["price"] = 40,
            ["itemType"] = u2.STONE_GAUNTLETS
        }
    }
end
return {
