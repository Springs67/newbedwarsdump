...
local function applyRef(p2, p3) -- Line: 36
...
local function setRobloxInstanceProperty(p4, p5, p6) -- Line: 51
...
local function removeBinding(p8, p9) -- Line: 64
    p8.bindings[p9]();
    p8.bindings[p9] = nil;
end;

local function attachBinding(u10, u11, p12) -- Line: 70
    -- upvalues: getDefaultInstanceProperty (copy), identity (copy), Binding (copy)
    local function updateBoundProperty(u13) -- Line: 71
        -- upvalues: u10 (copy), u11 (copy), getDefaultInstanceProperty (ref), identity (ref)
        local v17, v18 = xpcall(function() -- Line: 72
...
local function detachAllBindings(p20) -- Line: 97
...
local function applyProp(p21, p22, p23, p24) -- Line: 106
...
local function applyProps(p28, p29) -- Line: 148
...
local function updateProps(p30, p31, p32) -- Line: 154
    -- upvalues: applyProp (copy)
...
return {
    isHostObject = function(p33) -- Line: 174, Name: isHostObject
        return typeof(p33) == "Instance";
    end,

    mountHostNode = function(p34, u35) -- Line: 178, Name: mountHostNode
        ...
        u35.hostObject = v36;
        local v37, v38 = xpcall(function() -- Line: 194
    ...
    unmountHostNode = function(p41, p42) -- Line: 227, Name: unmountHostNode
    ...
    updateHostNode = function(p43, u44, p45) -- Line: 241, Name: updateHostNode
        ...
        local v46, v47 = xpcall(function() -- Line: 255
