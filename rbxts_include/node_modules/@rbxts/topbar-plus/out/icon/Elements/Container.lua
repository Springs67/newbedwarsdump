...
return function(u3) -- Line: 3
    ...
    local function checkInset(p11) -- Line: 16
        -- upvalues: GuiService (copy), u3 (copy), u10 (ref), checkInset (copy), u1 (ref), u6 (ref), u7 (ref), u8 (ref), u9 (ref), u5 (copy), u2 (ref)
        ...
        if u3.isOldTopbar and (not v13 and (u1 == false and (Height ~= 0 or p11 == "ForceConvertToOld"))) then
            ...
            task.defer(function() -- Line: 41
                ...
                local function decideToHideTopbar() -- Line: 48
    ...
    local function updateCenteredHoldersHeight() -- Line: 116
