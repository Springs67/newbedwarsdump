...
return function(u1) -- Line: 2
    ...
    u1:setBehaviour("Dropdown", "BackgroundTransparency", function(p2) -- Line: 17
    ...
    u1.janitor:add(GuiService:GetPropertyChangedSignal("PreferredTransparency"):Connect(function() -- Line: 25
    ...
    u1.dropdownChildAdded:Connect(function(u3) -- Line: 73
        ...
        task.defer(function() -- Line: 88
            ...
            u3.joinJanitor:add(function() -- Line: 89
                -- upvalues: u3 (ref), u4 (ref)
                u3:removeModification(u4);
            end);
        end);
    end);
    u1.dropdownSet:Connect(function(p5) -- Line: 94
    ...
    dropdownJanitor:add(u1.toggled:Connect(function() -- Line: 110, Name: updateVisibility
    ...
    local function updateMaxIcons() -- Line: 122
        ...
        table.sort(v10, function(p11, p12) -- Line: 148
            return p11[2] < p12[2];
        end);
