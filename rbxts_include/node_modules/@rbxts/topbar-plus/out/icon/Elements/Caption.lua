...
return function(u2) -- Line: 3
    ...
    Frame:GetPropertyChangedSignal("AbsoluteSize"):Connect(function() -- Line: 149
    ...
    captionJanitor:add(CanvasGroup:GetPropertyChangedSignal("AbsoluteSize"):Connect(function() -- Line: 159, Name: matchSize
    ...
    local function updateHotkey(p6) -- Line: 172
    ...
    local function getCaptionPosition(p11) -- Line: 198
        -- upvalues: u5 (ref)
        if p11 == nil then
            p11 = u5;
        end;
    ...
    local function updatePosition(p12) -- Line: 205
        ...
        local function updateCaret() -- Line: 234
        ...
        v20:Play();
        v20.Completed:Once(function() -- Line: 257
            -- upvalues: u21 (copy)
            u21:Disconnect();
        end);
    end;

    captionJanitor:add(u3:GetPropertyChangedSignal("AbsoluteSize"):Connect(function() -- Line: 262
    ...
    local function setCaptionEnabled(p26) -- Line: 278
    ...
    captionJanitor:add(u2.stateChanged:Connect(function(p29) -- Line: 303
        ...
        task.delay(v30, function() -- Line: 308
