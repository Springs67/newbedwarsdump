...
function u1.start(p3) -- Line: 25
    ...
    task.delay(1, function() -- Line: 34
        ...
        local function getIconFromSelectedObject() -- Line: 37
        ...
        local function updateSelectedObject() -- Line: 49
...
function u1.registerButton(u16) -- Line: 158
    -- upvalues: UserInputService (copy), GamepadService (copy), GuiService (copy)
    local u17 = false;
    u16.InputBegan:Connect(function(p18) -- Line: 164
        -- upvalues: u17 (ref)
        u17 = true;
        task.wait();
        task.wait();
    ...
    local u21 = UserInputService.InputBegan:Connect(function(p19) -- Line: 173
    ...
    u16.Destroying:Once(function() -- Line: 194
        -- upvalues: u21 (copy)
        u21:Disconnect();
    end);
end;
