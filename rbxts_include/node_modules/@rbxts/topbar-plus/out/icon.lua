...
function u4.getIcons() -- Line: 104
    -- upvalues: u4 (copy)
    return u4.iconsDictionary;
end;

function u4.getIconByUID(p8) -- Line: 108
    -- upvalues: u4 (copy)
    return u4.iconsDictionary[p8] or nil;
end;

function u4.getIcon(p9) -- Line: 116
...
function u4.setTopbarEnabled(p11, p12) -- Line: 129
    -- upvalues: u4 (copy)
...
function u4.modifyBaseTheme(p13) -- Line: 141
...
function u4.setDisplayOrder(p15) -- Line: 153
    -- upvalues: u4 (copy)
...
function u4.new() -- Line: 174
    ...
    local function handleToggle() -- Line: 267
        -- upvalues: u16 (copy)
        if u16.locked then
            return;
        end;
    ...
    local u21 = false;
    local u22 = false;
    v20.MouseButton1Click:Connect(function() -- Line: 279
        ...
        u22 = true;
        task.delay(0.01, function() -- Line: 284
            -- upvalues: u22 (ref)
            u22 = false;
        end);
    ...
    v20.TouchTap:Connect(function() -- Line: 289
        ...
        u21 = true;
        task.delay(0.01, function() -- Line: 296
            -- upvalues: u21 (ref)
            u21 = false;
        end);
    ...
    v17:add(UserInputService.InputBegan:Connect(function(p23, p24) -- Line: 303
        -- upvalues: u16 (copy)
        if u16.locked then
            return;
        end;
    ...
    local function viewingEnded() -- Line: 325
        -- upvalues: u16 (copy)
        if u16.locked then
            return;
        end;
    ...
    u16.joinedParent:Connect(function() -- Line: 333
        -- upvalues: u16 (copy)
    ...
    v20.SelectionGained:Connect(function(p27) -- Line: 315, Name: viewingStarted
        -- upvalues: u16 (copy)
        if u16.locked then
            return;
        end;
    ...
    v20.MouseButton1Up:Connect(function() -- Line: 358
        -- upvalues: u26 (ref)
        u26 = u26 + 1;
    end);
    local u29 = u16:getInstance("IconOverlay");
    u16.viewingStarted:Connect(function() -- Line: 364
        -- upvalues: u29 (copy), u16 (copy)
        u29.Visible = not u16.overlayDisabled;
    end);
    u16.viewingEnded:Connect(function() -- Line: 367
        -- upvalues: u29 (copy)
        u29.Visible = false;
    end);
    v17:add(u6:Connect(function(p30) -- Line: 372
        -- upvalues: u16 (copy)
    ...
    if v33 and (v34 and v34.ResetOnSpawn == true) then
        Utility.localPlayerRespawned(function() -- Line: 397
            -- upvalues: u16 (copy)
            u16:destroy();
        end);
    end;

    u16.toggled:Connect(function(p35) -- Line: 403
    ...
    u16.selected:Connect(function() -- Line: 426
    ...
    u16.deselected:Connect(function() -- Line: 439
        -- upvalues: u16 (copy), StarterGui (ref)
...
function u4.setState(p39, p40, p41, p42) -- Line: 475
...
function u4.getInstance(u44, u45) -- Line: 508
    ...
    local function cacheInstance(u47, u48) -- Line: 516
        -- upvalues: u44 (copy)
        if not u44.cachedInstances[u48] then
            ...
            u48.Destroying:Once(function() -- Line: 526
    ...
    local function scanChildren(p51) -- Line: 539
...
function u4.getCollective(p54, p55) -- Line: 568
...
function u4.getInstanceOrCollective(p58, p59) -- Line: 589
    local v60 = {};
...
function u4.getStateGroup(p62, p63) -- Line: 603
...
function u4.refreshAppearance(p66, p67, p68) -- Line: 613
    -- upvalues: Themes (copy)
...
function u4.refresh(p69) -- Line: 618
...
function u4.updateParent(p70) -- Line: 624
    -- upvalues: u4 (copy)
...
function u4.setBehaviour(p72, p73, p74, p75, p76) -- Line: 631
...
function u4.modifyTheme(p78, p79, p80) -- Line: 644
    -- upvalues: Themes (copy)
    return p78, Themes.modify(p78, p79, p80);
end;

function u4.modifyChildTheme(p81, p82, p83) -- Line: 649
    -- upvalues: u4 (copy)
...
function u4.removeModification(p84, p85) -- Line: 662
    -- upvalues: Themes (copy)
...
function u4.removeModificationWith(p86, p87, p88, p89) -- Line: 667
    -- upvalues: Themes (copy)
...
function u4.setTheme(p90, p91) -- Line: 672
    -- upvalues: Themes (copy)
    Themes.set(p90, p91);
...
function u4.setEnabled(p92, p93) -- Line: 677
    p92.isEnabled = p93;
...
function u4.select(p94, p95, p96) -- Line: 685
    p94:setState("Selected", p95, p96);

    return p94;
end;

function u4.deselect(p97, p98, p99) -- Line: 690
    p97:setState("Deselected", p98, p99);

    return p97;
end;

function u4.notify(p100, p101, p102) -- Line: 695
...
function u4.clearNotices(p103) -- Line: 709
    p103.endNotices:Fire();

    return p103;
end;

function u4.disableOverlay(p104, p105) -- Line: 714
...
function u4.setImage(p106, p107, p108) -- Line: 720
    p106:modifyTheme({
        "IconImage",
        "Image",
        p107,
...
function u4.setLabel(p109, p110, p111) -- Line: 725
    p109:modifyTheme({
        "IconLabel",
        "Text",
        p110,
...
function u4.setOrder(p112, p113, p114) -- Line: 730
    local v115 = p113 * 100;
    p112:modifyTheme({
        "IconSpot",
        "LayoutOrder",
...
function u4.setCornerRadius(p116, p117, p118) -- Line: 739
    p116:modifyTheme({
        "IconCorners",
        "CornerRadius",
        p117,
...
function u4.align(p119, p120, p121) -- Line: 744
    -- upvalues: u4 (copy)
...
function u4.setLeft(p128) -- Line: 773
    p128:setAlignment("Left");

    return p128;
end;

function u4.setMid(p129) -- Line: 778
    p129:setAlignment("Center");

    return p129;
end;

function u4.setRight(p130) -- Line: 783
    p130:setAlignment("Right");

    return p130;
end;

function u4.setWidth(p131, p132, p133) -- Line: 788
    p131:modifyTheme({
        "Widget",
        "DesiredWidth",
        p132,
...
function u4.setImageScale(p134, p135, p136) -- Line: 796
    p134:modifyTheme({
        "IconImageScale",
        "Value",
        p135,
...
function u4.setImageRatio(p137, p138, p139) -- Line: 801
    p137:modifyTheme({
        "IconImageRatio",
        "AspectRatio",
        p138,
...
function u4.setTextSize(p140, p141, p142) -- Line: 806
    p140:modifyTheme({
        "IconLabel",
        "TextSize",
        p141,
...
function u4.setTextFont(p143, p144, p145, p146, p147) -- Line: 811
...
function u4.bindToggleItem(p152, p153) -- Line: 832
...
function u4.unbindToggleItem(p154, p155) -- Line: 841
...
function u4._updateSelectionInstances(p156) -- Line: 847
...
function u4._setToggleItemsVisible(p158, p159, p160, p161) -- Line: 861
...
function u4.bindEvent(u162, p163, u164) -- Line: 873
    ...
    u162.bindedEvents[p163] = v165:Connect(function(...) -- Line: 877
...
function u4.unbindEvent(p168, p169) -- Line: 883
...
function u4.bindToggleKey(p171, p172) -- Line: 892
...
function u4.unbindToggleKey(p174, p175) -- Line: 900
...
function u4.call(u177, u178, ...) -- Line: 906
    local u179 = table.pack(...);
    task.spawn(function() -- Line: 908
...
function u4.addToJanitor(p180, p181, p182, p183) -- Line: 914
    p180.janitor:add(p181, p182, p183);

    return p180;
end;

function u4.lock(p184) -- Line: 919
...
function u4.unlock(p185) -- Line: 927
...
function u4.debounce(p186, p187) -- Line: 934
    p186:lock();
    task.wait(p187);
    p186:unlock();
...
function u4.setCaption(p192, p193) -- Line: 965
...
function u4.setCaptionHint(p195, p196) -- Line: 983
...
function u4.leave(p198) -- Line: 991
    p198.joinJanitor:clean();

    return p198;
end;

function u4.joinMenu(p199, p200) -- Line: 997
...
function u4.setMenu(p201, p202) -- Line: 1003
    p201.menuSet:Fire(p202);

    return p201;
end;

function u4.setFrozenMenu(p203, p204) -- Line: 1008
    p203:freezeMenu(p204);
    p203:setMenu(p204);
end;

function u4.freezeMenu(u205) -- Line: 1013
    u205:select("FrozenMenu", u205);
    u205:bindEvent("deselected", function(p206) -- Line: 1017
        -- upvalues: u205 (copy)
...
function u4.joinDropdown(p207, p208) -- Line: 1023
    -- upvalues: Utility (copy)
    p208:getDropdown();
...
function u4.getDropdown(p209) -- Line: 1030
    -- upvalues: Elements (copy)
...
function u4.setDropdown(p210, p211) -- Line: 1040
    p210:getDropdown();
...
function u4.clipOutside(p212, p213) -- Line: 1046
    -- upvalues: Utility (copy)
...
function u4.setIndicator(p215, p216) -- Line: 1057
    -- upvalues: Elements (copy), u4 (copy)
...
function u4.convertLabelToNumberSpinner(u217, u218) -- Line: 1069
    ...
    for _, v in ipairs({ "FontFace", "BorderSizePixel", "BorderColor3", "Rotation", "TextStrokeTransparency", "TextStrokeColor3", "TextStrokeTransparency", "TextColor3" }) do
        u218[v] = u219[v];
        u217:addToJanitor(u219:GetPropertyChangedSignal(v):Connect(function() -- Line: 1091
            -- upvalues: u218 (copy), v (copy), u219 (copy)
            u218[v] = u219[v];
        end));
    end;

    local function getSpinnerSizeAndDigitCount() -- Line: 1098
        -- upvalues: u218 (copy)
        local v220 = 0;
        local v221 = 0;
    ...
    local function getLabelParentContainerXSize() -- Line: 1116
    ...
    local function getNumberSpinnerXSize() -- Line: 1127
        -- upvalues: u218 (copy)
        return u218.Frame.AbsoluteSize.X;
    end;

    local function adjustSize() -- Line: 1131
    ...
    u217:addToJanitor(u217.iconAdded:Connect(function() -- Line: 1169
...
function u4.destroy(p228) -- Line: 1191
    -- upvalues: u4 (copy)
