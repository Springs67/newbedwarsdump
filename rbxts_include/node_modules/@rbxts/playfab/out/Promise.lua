...
local function makeEnum(u2, p3) -- Line: 14
    local v4 = {};
    ...
    return setmetatable(v4, {
        __index = function(p5, p6) -- Line: 22, Name: __index
            -- upvalues: u2 (copy)
            error(string.format("%s is not in %s!", p6, u2), 2);
        end,

        __newindex = function() -- Line: 25, Name: __newindex
            -- upvalues: u2 (copy)
...
function u7.isKind(p16, p17) -- Line: 72
    -- upvalues: u7 (ref)
...
function u7.extend(p19, p20) -- Line: 78
    -- upvalues: u7 (ref)
    local v21 = p20 or {};
...
function u7.getErrorChain(p22) -- Line: 86
    local v23 = { p22 };
...
function u7.__tostring(p24) -- Line: 96
...
local function pack(...) -- Line: 117
    return select("#", ...), { ... };
end;

local function packResult(p26, ...) -- Line: 124
    return p26, select("#", ...), { ... };
end;

local function makeErrorHandler(u27) -- Line: 129
    -- upvalues: u7 (ref)
    assert(u27 ~= nil);

    return function(p28) -- Line: 132
...
local function runExecutor(u29, p30, ...) -- Line: 152
    -- upvalues: packResult (copy), u7 (ref)
    local v31 = xpcall;
    assert(u29 ~= nil);

    return packResult(v31(p30, function(p32) -- Line: 132
...
local function createAdvancer(u33, u34, u35, u36) -- Line: 160
...
local function isEmpty(p40) -- Line: 172
    return next(p40) == nil;
end;
...
function u41._new(p42, u43, p44) -- Line: 197
    ...
    local function resolve(...) -- Line: 242
        -- upvalues: u45 (copy)
        u45:_resolve(...);
    end;

    local function reject(...) -- Line: 246
        -- upvalues: u45 (copy)
        u45:_reject(...);
    end;

    local function onCancel(p46) -- Line: 250
    ...
    coroutine.wrap(function() -- Line: 262
...
function u41.resolve(...) -- Line: 314
    -- upvalues: pack (copy), u41 (copy)
    local u59, u60 = pack(...);

    return u41._new(debug.traceback(nil, 2), function(p61) -- Line: 316
        -- upvalues: u60 (copy), u59 (copy)
        p61(unpack(u60, 1, u59));
    end);
end;

function u41.reject(...) -- Line: 324
    -- upvalues: pack (copy), u41 (copy)
    local u62, u63 = pack(...);

    return u41._new(debug.traceback(nil, 2), function(p64, p65) -- Line: 326
        -- upvalues: u63 (copy), u62 (copy)
        p65(unpack(u63, 1, u62));
    end);
end;

function u41._try(p66, u67, ...) -- Line: 335
    -- upvalues: pack (copy), u41 (copy)
    local u68, u69 = pack(...);

    return u41._new(p66, function(p70) -- Line: 338
        -- upvalues: u67 (copy), u69 (copy), u68 (copy)
        p70(u67(unpack(u69, 1, u68)));
    end);
end;

function u41.try(...) -- Line: 346
    -- upvalues: u41 (copy)
    return u41._try(debug.traceback(nil, 2), ...);
end;

function u41._all(p71, u72, u73) -- Line: 355
    -- upvalues: u41 (copy)
    ...
    return u41._new(p71, function(u74, u75, p76) -- Line: 373
        ...
        local function resolveOne(p82, ...) -- Line: 391
        ...
        p76(function() -- Line: 384, Name: cancel
            -- upvalues: u78 (copy)
            for _, v in ipairs(u78) do
                v:cancel();
            end;
        ...
        for i, v in ipairs(u72) do
            u78[i] = v:andThen(function(...) -- Line: 417
...
function u41.all(p83) -- Line: 439
    -- upvalues: u41 (copy)
    return u41._all(debug.traceback(nil, 2), p83);
end;

function u41.some(p84, p85) -- Line: 443
    -- upvalues: u41 (copy)
...
function u41.any(p87) -- Line: 449
    -- upvalues: u41 (copy)
    return u41._all(debug.traceback(nil, 2), p87, 1):andThen(function(p88) -- Line: 450
        return p88[1];
    end);
end;

function u41.allSettled(u89) -- Line: 455
    -- upvalues: u41 (copy)
    ...
    return u41._new(debug.traceback(nil, 2), function(u90, p91, p92) -- Line: 473
        -- upvalues: u89 (copy)
        local u93 = {};
        local u94 = {};
        local u95 = 0;

        local function u97(p96, ...) -- Line: 483
        ...
        for i, v in ipairs(u89) do
            u94[i] = v:finally(function(...) -- Line: 503
...
function u41.race(u98) -- Line: 515
    -- upvalues: u41 (copy)
    ...
    return u41._new(debug.traceback(nil, 2), function(u102, u103, p104) -- Line: 522
        -- upvalues: u98 (copy)
        local u105 = {};
        local u106 = false;

        local function cancel() -- Line: 526
            -- upvalues: u105 (copy)
        ...
        local function finalize(u107) -- Line: 532
            -- upvalues: u105 (copy), u106 (ref)
            return function(...) -- Line: 533
        ...
        for i, v in ipairs(u98) do
            u105[i] = v:andThen(function(...) -- Line: 533
...
function u41.each(u108, u109) -- Line: 562
    ...
    return u41._new(debug.traceback(nil, 2), function(p112, p113, p114) -- Line: 566
        -- upvalues: u108 (copy), u41 (ref), u7 (ref), u109 (copy)
        local v115 = {};
        local u116 = {};
        local u117 = false;

        local function _() -- Line: 572
            -- upvalues: u116 (copy)
        ...
        for i, v in ipairs(u108) do
            if u41.is(v) then
                ...
                local v119 = v:andThen(function(...) -- Line: 611
                    return ...;
                end);
...
function u41.promisify(u129) -- Line: 686
    -- upvalues: u41 (copy)
...
function u41.delay(p132) -- Line: 702
    ...
    return u41._new(debug.traceback(nil, 2), function(p135, p136, p137) -- Line: 710
        ...
        if u131 == nil then
            u130 = u140;
            u131 = u41._timeEvent:Connect(function() -- Line: 722
...
function u41.prototype.timeout(p144, u145, u146) -- Line: 796
    -- upvalues: u41 (copy), u7 (ref)
    local u147 = debug.traceback(nil, 2);

    return u41.race({ u41.delay(u145):andThen(function() -- Line: 800
...
function u41.prototype.getStatus(p148) -- Line: 815
    return p148._status;
end;

function u41.prototype._andThen(u149, u150, u151, u152) -- Line: 824
    -- upvalues: u41 (copy), runExecutor (copy), u7 (ref)
    u149._unhandledRejection = false;

    return u41._new(u150, function(u153, u154) -- Line: 828
...
function u41.prototype.andThen(p167, p168, p169) -- Line: 874
...
function u41.prototype.catch(p172, p173) -- Line: 890
...
function u41.prototype.tap(p175, u176) -- Line: 902
    ...
    return p175:_andThen(debug.traceback(nil, 2), function(...) -- Line: 904
        ...
        return v178:andThen(function() -- Line: 909
...
function u41.prototype.andThenCall(p181, u182, ...) -- Line: 921
    -- upvalues: pack (copy)
    ...
    return p181:_andThen(debug.traceback(nil, 2), function() -- Line: 924
        -- upvalues: u182 (copy), u185 (copy), u184 (copy)
        return u182(unpack(u185, 1, u184));
    end);
end;

function u41.prototype.andThenReturn(p186, ...) -- Line: 932
    -- upvalues: pack (copy)
    local u187, u188 = pack(...);

    return p186:_andThen(debug.traceback(nil, 2), function() -- Line: 934
        -- upvalues: u188 (copy), u187 (copy)
        return unpack(u188, 1, u187);
    end);
end;

function u41.prototype.cancel(p189) -- Line: 943
    -- upvalues: u41 (copy)
...
function u41.prototype._consumerCancelled(p190, p191) -- Line: 969
    -- upvalues: u41 (copy)
...
function u41.prototype._finally(u192, u193, u194, u195) -- Line: 985
    -- upvalues: u41 (copy), runExecutor (copy)
    if not u195 then
        u192._unhandledRejection = false;
    end;

    return u41._new(u193, function(u196, u197) -- Line: 991
        ...
        local v204 = u195 and function(...) -- Line: 1004
...
function u41.prototype.finally(p205, p206) -- Line: 1023
...
function u41.prototype.finallyCall(p208, u209, ...) -- Line: 1034
    -- upvalues: pack (copy)
    ...
    return p208:_finally(debug.traceback(nil, 2), function() -- Line: 1037
        -- upvalues: u209 (copy), u212 (copy), u211 (copy)
        return u209(unpack(u212, 1, u211));
    end);
end;

function u41.prototype.finallyReturn(p213, ...) -- Line: 1045
    -- upvalues: pack (copy)
    local u214, u215 = pack(...);

    return p213:_finally(debug.traceback(nil, 2), function() -- Line: 1047
        -- upvalues: u215 (copy), u214 (copy)
        return unpack(u215, 1, u214);
    end);
end;

function u41.prototype.done(p216, p217) -- Line: 1055
...
function u41.prototype.doneCall(p219, u220, ...) -- Line: 1066
    -- upvalues: pack (copy)
    ...
    return p219:_finally(debug.traceback(nil, 2), function() -- Line: 1069
        -- upvalues: u220 (copy), u223 (copy), u222 (copy)
        return u220(unpack(u223, 1, u222));
    end, true);
end;

function u41.prototype.doneReturn(p224, ...) -- Line: 1077
    -- upvalues: pack (copy)
    local u225, u226 = pack(...);

    return p224:_finally(debug.traceback(nil, 2), function() -- Line: 1079
        -- upvalues: u226 (copy), u225 (copy)
        return unpack(u226, 1, u225);
    end, true);
end;

function u41.prototype.awaitStatus(p227) -- Line: 1089
    -- upvalues: u41 (copy)
    p227._unhandledRejection = false;

    if p227._status == u41.Status.Started then
        local BindableEvent = Instance.new("BindableEvent");
        p227:finally(function() -- Line: 1095
...
local function awaitHelper(p228, ...) -- Line: 1112
    -- upvalues: u41 (copy)
    return p228 == u41.Status.Resolved, ...;
end;

function u41.prototype.await(p229) -- Line: 1119
    -- upvalues: awaitHelper (copy)
    return awaitHelper(p229:awaitStatus());
end;

local function expectHelper(p230, ...) -- Line: 1123
    -- upvalues: u41 (copy)
...
function u41.prototype.expect(p231) -- Line: 1135
...
function u41.prototype._unwrap(p232) -- Line: 1149
    -- upvalues: u41 (copy)
...
function u41.prototype._resolve(u233, ...) -- Line: 1159
    ...
    if u41.is((...)) then
        ...
        local u235 = ...;
        local v237 = u235:andThen(function(...) -- Line: 1182
            -- upvalues: u233 (copy)
            u233:_resolve(...);
        end, function(...) -- Line: 1185
...
function u41.prototype._reject(u240, ...) -- Line: 1234
    -- upvalues: u41 (copy), pack (copy)
    ...
    if next(u240._queuedReject) == nil then
        local u243 = tostring((...));
        coroutine.wrap(function() -- Line: 1256
...
function u41.prototype._finalize(p245) -- Line: 1288
    -- upvalues: u41 (copy)
...
function u41.prototype.now(p246, p247) -- Line: 1311
    -- upvalues: u41 (copy), u7 (ref)
    local v248 = debug.traceback(nil, 2);

    if p246:getStatus() == u41.Status.Resolved then
        return p246:_andThen(v248, function(...) -- Line: 1314
            return ...;
        end);
    end;
...
function u41.retry(u249, u250, ...) -- Line: 1329
    -- upvalues: u41 (copy)
    ...
    return u41.resolve(u249(...)):catch(function(...) -- Line: 1335
