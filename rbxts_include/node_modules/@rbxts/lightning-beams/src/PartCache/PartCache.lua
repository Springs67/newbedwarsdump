local u1 = require(script.Parent:WaitForChild("Table"))
local u2 = {}
u2.__index = u2
u2.__type = "PartCache"
local u3 = CFrame.new(0, 1000000000, 0)
function u2.new(p4, p5, p6) --[[ Line: 77 ]]
    --[[
    Upvalues:
        [1] = u2
        [2] = u1
...
function u2.GetPart(p18) --[[ Line: 115 ]]
    --[[
    Upvalues:
        [1] = u2
        [2] = u1
    ...
    u1.insert(p18.InUse, v28)
    return v28
end
function u2.ReturnPart(p29, p30) --[[ Line: 131 ]]
    --[[
    Upvalues:
        [1] = u2
        [2] = u1
    ...
    local v32 = u1.indexOf(p29.InUse, p30)
    if v32 == nil then
        ...
        u1.remove(p29.InUse, v32)
        u1.insert(p29.Open, p30)
        p30.CFrame = u3
        p30.Anchored = true
    end
end
function u2.SetCacheParent(p33, p34) --[[ Line: 146 ]]
    --[[
    Upvalues:
        [1] = u2
    --]]
    local v35 = getmetatable(p33) == u2
...
function u2.Expand(p39, p40) --[[ Line: 160 ]]
    --[[
    Upvalues:
        [1] = u2
        [2] = u1
...
function u2.Dispose(p47) --[[ Line: 172 ]]
    --[[
    Upvalues:
        [1] = u2
    --]]
    local v48 = getmetatable(p47) == u2
