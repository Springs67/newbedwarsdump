...
function u2.contains(p3, p4) -- Line: 30
    -- upvalues: u2 (copy)
    return u2.indexOf(p3, p4) ~= nil;
end;

function u2.indexOf(p5, p6) -- Line: 35
    -- upvalues: u2 (copy)
    return table.find(p5, p6) or u2.keyOf(p5, p6);
end;

function u2.keyOf(p7, p8) -- Line: 44
...
function u2.expand(p26, p27) -- Line: 95
    if p27 < 0 then
