return {
    ["encode"] = function(p1) --[[ Name: enc, Line 8 ]]
        return (p1:gsub(".", function(p2) --[[ Line: 9 ]]
            local v3 = p2:byte()
            local v4 = ""
            for v5 = 8, 1, -1 do
            ...
            return v4
        end) .. "0000"):gsub("%d%d%d?%d?%d?%d?", function(p6) --[[ Line: 13 ]]
            if #p6 < 6 then
                return ""
            end
            local v7 = 0
    ...
    ["decode"] = function(p9) --[[ Name: dec, Line 22 ]]
        return string.gsub(p9, "[^ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=]", ""):gsub(".", function(p10) --[[ Line: 24 ]]
            if p10 == "=" then
                return ""
            end
            ...
            return v12
        end):gsub("%d%d%d?%d?%d?%d?%d?%d?", function(p14) --[[ Line: 29 ]]
            if #p14 ~= 8 then
                return ""
            end
            local v15 = 0
