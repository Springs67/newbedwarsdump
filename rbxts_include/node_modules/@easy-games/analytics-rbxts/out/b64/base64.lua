...
return {
    encode = function(p1) -- Line: 8, Name: enc
        return (p1:gsub(".", function(p2) -- Line: 9
            ...
            return v4;
        end) .. "0000"):gsub("%d%d%d?%d?%d?%d?", function(p5) -- Line: 13
            if #p5 < 6 then
                return "";
            end;
    ...
    decode = function(p7) -- Line: 22, Name: dec
        return string.gsub(p7, "[^ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=]", ""):gsub(".", function(p8) -- Line: 24
            if p8 == "=" then
                return "";
            end;
            ...
            return v10;
        end):gsub("%d%d%d?%d?%d?%d?%d?%d?", function(p11) -- Line: 29
            if #p11 ~= 8 then
                return "";
            end;
