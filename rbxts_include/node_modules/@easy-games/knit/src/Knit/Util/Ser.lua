...
local u2 = {
    Classes = {
        Option = {
            Serialize = function(p1) -- Line: 36, Name: Serialize
                return p1:Serialize();
            end,
...
function u2.SerializeArgs(...) -- Line: 42
    -- upvalues: u2 (copy)
    local v3 = table.pack(...);
...
function u2.SerializeArgsAndUnpack(...) -- Line: 56
    -- upvalues: u2 (copy)
...
function u2.DeserializeArgs(...) -- Line: 62
    -- upvalues: u2 (copy)
    local v6 = table.pack(...);
...
function u2.DeserializeArgsAndUnpack(...) -- Line: 76
    -- upvalues: u2 (copy)
...
function u2.Serialize(p9) -- Line: 82
    -- upvalues: u2 (copy)
...
function u2.Deserialize(p11) -- Line: 93
    -- upvalues: u2 (copy)
...
function u2.UnpackArgs(p13) -- Line: 104
